...
$_LANG['user_bonus'] = '用户抵扣券';
$_LANG['user_bonus_info'] = '共计 %d 个,价值 %s';
$_LANG['not_bonus'] = '没有抵扣券';
$_LANG['add_user_bonus'] = '添加一个抵扣券';
$_LANG['bonus_number'] = '抵扣券序列号';
$_LANG['old_password'] = '原密码';
$_LANG['new_password'] = '新密码';
$_LANG['confirm_password'] = '确认密码';

$_LANG['bonus_sn_exist'] = '此抵扣券号码已经被占用了！';
$_LANG['bonus_sn_not_exist'] = '此抵扣券号码不存在！';
$_LANG['add_bonus_sucess'] = '添加新的抵扣券操作成功！';
$_LANG['add_bonus_false'] = '添加新的抵扣券操作失败！';
...
//JS语言项
$_LANG['profile_js']['bonus_sn_empty'] = '请输入您要添加的抵扣券号码！';
$_LANG['profile_js']['bonus_sn_error'] = '您输入的抵扣券号码格式不正确！';
...
/* 会员抵扣券 */
$_LANG['bonus_is_used'] = '你输入的抵扣券你已经领取过了！';
$_LANG['bonus_is_used_by_other'] = '你输入的抵扣券已经被其他人领取！';
$_LANG['bonus_add_success'] = '您已经成功的添加了一个新的抵扣券！';
$_LANG['bonus_not_exist'] = '你输入的抵扣券不存在';
$_LANG['user_bonus_empty'] = '您现在还没有抵扣券';
$_LANG['add_bonus_sucess'] = '添加新的抵扣券操作成功！';
$_LANG['add_bonus_false'] = '添加新的抵扣券操作失败！';
$_LANG['bonus_add_expire'] = '该抵扣券已经过期！';
$_LANG['bonus_use_expire'] = '该抵扣券已经过了使用期！';
...
$_LANG['merge'] = '合并';
$_LANG['notice_order_sn'] = '当两个订单不一致时，合并后的订单信息（如：支付方式、配送方式、包装、贺卡、抵扣券等）以第二个为准。';
$_LANG['subtotal'] = '小计';
...
/* 抵扣券详情 */
$_LANG['bonus_sn'] = '抵扣券序号';
$_LANG['bonus_name'] = '抵扣券名称';
$_LANG['bonus_amount'] = '抵扣券金额';
$_LANG['min_goods_amount'] = '最小订单金额';
$_LANG['bonus_end_date'] = '截至使用日期';
$_LANG['bonus_status'] = '抵扣券状态';
