...
$_LANG['invalid_bonus'] = "您选择的抵扣券并不存在。";
...
$_LANG['flow_js']['zipcode_not_num'] = '邮政编码只能填写数字';
...
$_LANG['validate_bonus'] = '验证抵扣券';
$_LANG['input_bonus_no'] = '或者输入抵扣券序列号';
$_LANG['select_bonus'] = '选择已有抵扣券';
$_LANG['bonus_sn_error'] = '该抵扣券序列号不正确';
$_LANG['bonus_min_amount_error'] = '订单商品金额没有达到使用该抵扣券的最低金额 %s';
$_LANG['bonus_is_ok'] = '该抵扣券序列号可以使用，可以抵扣 %s';
