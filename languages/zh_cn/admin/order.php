...
$_LANG['bonus_not_available'] = '该订单使用抵扣券支付，现在抵扣券不可用';
...
$_LANG['merge'] = '合并';
$_LANG['notice_order_sn'] = '当两个订单不一致时，合并后的订单信息（如：支付方式、配送方式、包装、贺卡、抵扣券等）以主订单为准。';
...
$_LANG['delivery_print'] = '发货单信息';
$_LANG['op_delivery_print'] = '打印发货单';
