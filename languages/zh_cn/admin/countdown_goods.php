...
/* menu */
$_LANG['countdown_goods_list'] = '倒计时活动列表';
$_LANG['add_countdown_goods'] = '添加倒计时活动';
$_LANG['edit_countdown_goods'] = '编辑倒计时活动';
$_LANG['favourable_log'] = '优惠活动出价记录';
$_LANG['continue_add_countdown_goods'] = '继续添加倒计时活动';
$_LANG['back_countdown_goods_list'] = '返回倒计时活动列表';
$_LANG['add_countdown_goods_ok'] = '添加倒计时活动成功';
$_LANG['edit_countdown_goods_ok'] = '编辑倒计时活动成功';

/* list */
$_LANG['act_is_going'] = '仅显示进行中的活动';
$_LANG['act_name'] = '倒计时活动名称';
...
$_LANG['countdown_not_exist'] = '您要操作的倒计时活动不存在';
$_LANG['js_languages']['batch_drop_confirm'] = '您确实要删除选中的倒计时活动吗？';
$_LANG['batch_drop_ok'] = '批量删除成功';
$_LANG['no_record_selected'] = '没有选择记录';

/* info */
$_LANG['label_act_name'] = '倒计时活动名称：';
$_LANG['label_start_time'] = '倒计时活动开始时间：';
$_LANG['label_end_time'] = '倒计时活动结束时间：';
...
$_LANG['label_act_url'] = '倒计时活动链接：';
$_LANG['label_act_img'] = '倒计时活动图片：';
$_LANG['notice_max_amount'] = '0表示没有上限';
$_LANG['label_act_type'] = '优惠方式：';

$_LANG['warn_actimg'] = '你已经上传过图片。再次上传时将覆盖原图片';

$_LANG['drop_act_img'] = '删除倒计时活动图片';
$_LANG['confirm_drop_act_img'] = '你确认删除该倒计时活动图片吗？';
$_LANG['drop_act_img_success'] = '删除倒计时活动图片成功';

$_LANG['act_edit_lnk'] = '重新编辑该活动';
$_LANG['act_list_lnk'] = '返回列表页面';
...
$_LANG['js_languages']['act_photo_empty'] = '活动的图片不能为空!';
$_LANG['js_languages']['act_name_not_null'] = '请输入倒计时活动名称';
$_LANG['js_languages']['act_url_not_null'] = '请输入倒计时活动链接';
$_LANG['js_languages']['start_lt_end'] = '活动开始时间不能大于结束时间';
