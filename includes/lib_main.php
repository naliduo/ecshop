...
function show_logout_message($content, $links = '', $hrefs = '', $type = 'info', $auto_redirect = true)
{
    ...
    $GLOBALS['smarty']->assign('auto_redirect', $auto_redirect);
    $GLOBALS['smarty']->assign('message', $msg);
    $GLOBALS['smarty']->display('message_logout.dwt');
...
function show_login_message($content, $links = '', $hrefs = '', $type = 'info', $auto_redirect = true)
{
    ...
    $GLOBALS['smarty']->assign('auto_redirect', $auto_redirect);
    $GLOBALS['smarty']->assign('message', $msg);
    $GLOBALS['smarty']->assign('jhy_web_url', "http://112.124.110.58:8080/index.php?login=".$_SESSION['user_id']."&n=".$_SESSION['user_name']."&rankid=".$_SESSION['rankid']."&rankname=".$_SESSION['rankname']."&img=".$_SESSION['avatar']."&alias=".$_SESSION['alias']);
...
function assign_template($ctype = '', $catlist = array())
{
	...
	if(isset($GLOBALS['_LANG']['copyright']))
	{
