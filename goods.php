...
//-- PROCESSOR
/*------------------------------------------------------ */
$bindusercard = $db->getOne("select count(is_bind_card) from ".$ecs->table("goods")." where is_bind_card='2' and goods_id=".$goods_id);
if($bindusercard){
...
if (!$smarty->is_cached('goods.dwt', $cache_id))
{
    ...
    else
    {
        ...
        $smarty->assign('package_goods_list_120',$package_goods_list_120);    // 
		/* 代码增加_end By . */
