...
$modules['04_order']['11_export_order']               = 'order_export.php';

$modules['05_banner']['ad_position']                = 'ad_position.php?act=list';
$modules['05_banner']['ad_list']                    = 'ads.php?act=list';
$modules['05_banner']['flashplay']                  = 'flashplay.php?act=list';
...
$modules['06_stats']['send_sell']                 = 'send_order.php?act=goods_num';
...
$modules['12_taocan']['1_system_taocan']             = 'system_taocan.php?act=list';
$modules['12_taocan']['2_user_taocan']               = 'user_taocan.php?act=list';
$modules['12_taocan']['3_system_job']               = 'taocan_job.php';
