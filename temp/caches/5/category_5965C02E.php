  ...
  <div class="span12">
    ...
    <div class="xm-box category-filter-box">
      <div class="hd">
        ...
        <div class="category-filter-meta">共8个商品</div>
      </div>
	        <div class="bd">
          ...
          <dd>
            <ul>
											<li class="current"><a>全部</a></li>
																<li><a href="category.php?id=29&amp;brand=4&amp;price_min=0&amp;price_max=0">君禾园</a></li>
								            </ul>
          </dd>
        </dl>
    ...
    <div class="xm-box category-list-box"><div class="hd">
        <div class="category-list-order">
          <dl class="xm-filter-list category-order-list clearfix">
            ...
            <dd>
              <ul id="typeSort">
                <li class="DESC"><a href="category.php?category=29&display=grid&brand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=goods_id&order=ASC#goods_list"><span class="icon-common icon-order-ascending"></span>按上架时间</a></li>
                <li class="default"><a href="category.php?category=29&display=grid&brand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=shop_price&order=ASC#goods_list"><span class="icon-common icon-order-ascending"></span>价格由低到高</a></li>
                <li class="default"><a href="category.php?category=29&display=grid&brand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=last_update&order=DESC#goods_list"><span class="icon-common icon-order-ascending"></span>按更新时间排序</a></li>
              </ul>
            </dd>
          </dl>
        </div>
          ...
          <ul class="xm-goods-list clearfix">
              ...
              <div class="xm-goods-item">
                ...
                <div class="item-flags"><span class="icon-saleoff icon-saleoff-0">新品</span></div>
                                ...
                                <li>
              <div class="xm-goods-item">
                <div class="item-thumb"><a href="goods.php?id=60" title="白扁豆仁（新鲜）"><img src="images/201409/thumb_img/60_thumb_G_1411603470126.jpg" alt="白扁豆仁（新鲜）" /></a></div>
                <h2 class="item-name"><a href="goods.php?id=60" title="白扁豆仁（新鲜）">白扁豆仁（新鲜）</a></h2>
                <div class="item-price">￥16.68元<del>￥19.00元</del></div>
                <div class="item-action"><a class="action-add-cart xmAddShopCart" href="javascript:addToCart(60)" ><span class="icon-common icon-common-plus"></span>加入购物车</a></div>
                <div class="item-flags"><span class="icon-saleoff icon-saleoff-0">新品</span></div>
              </div>
            </li>
                                <li>
              ...
              <div class="xm-goods-item">
                ...
                <div class="item-flags"><span class="icon-saleoff icon-saleoff-0"></span></div>
                                ...
                                <li>
              <div class="xm-goods-item">
                <div class="item-thumb"><a href="goods.php?id=44" title="冬瓜"><img src="images/201409/thumb_img/44_thumb_G_1410724417773.jpg" alt="冬瓜" /></a></div>
                <h2 class="item-name"><a href="goods.php?id=44" title="冬瓜">冬瓜</a></h2>
                <div class="item-price">￥22.00元<del>￥25.00元</del></div>
                <div class="item-action"><a class="action-add-cart xmAddShopCart" href="javascript:addToCart(44)" ><span class="icon-common icon-common-plus"></span>加入购物车</a></div>
                <div class="item-flags"><span class="icon-saleoff icon-saleoff-0"></span></div>
              </div>
            </li>
                                <li>
              <div class="xm-goods-item">
                ...
                <div class="item-flags"><span class="icon-saleoff icon-saleoff-0"></span></div>
                                ...
                                <li>
              <div class="xm-goods-item">
                <div class="item-thumb"><a href="goods.php?id=39" title="菜椒"><img src="images/201409/thumb_img/39_thumb_G_1410725133366.jpg" alt="菜椒" /></a></div>
                <h2 class="item-name"><a href="goods.php?id=39" title="菜椒">菜椒</a></h2>
                <div class="item-price">￥16.68元<del>￥19.00元</del></div>
                <div class="item-action"><a class="action-add-cart xmAddShopCart" href="javascript:addToCart(39)" ><span class="icon-common icon-common-plus"></span>加入购物车</a></div>
                <div class="item-flags"><span class="icon-saleoff icon-saleoff-0"></span></div>
              </div>
            </li>
        ...
        <div class="xm-box category-list-box">
          <div class="xm-pagenavi">
		  		  <span class="numbers first">上一页</span>
		  		  		  ...
		  		  		  <span class="numbers current"><a href="category.php?id=29&amp;price_min=0&amp;price_max=0&amp;page=1&amp;sort=goods_id&amp;order=DESC">1</a></span>
