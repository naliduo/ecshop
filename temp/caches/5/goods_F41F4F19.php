<?php exit;?>a:3:{s:8:"template";a:5:{i:0;s:35:"D:/WWW/shop/themes/xm2013/goods.dwt";i:1;s:49:"D:/WWW/shop/themes/xm2013/library/page_header.lbi";i:2;s:45:"D:/WWW/shop/themes/xm2013/library/ur_here.lbi";i:3;s:45:"D:/WWW/shop/themes/xm2013/library/history.lbi";i:4;s:49:"D:/WWW/shop/themes/xm2013/library/page_footer.lbi";}s:7:"expires";i:1446897141;s:8:"maketime";i:1446893541;}<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<meta name="Keywords" content="" />
<meta name="Description" content="" />
<title>塌菜_叶菜类_蔬菜类_君禾园</title>
...
_mvq.push(['$addGoods', '11', '4', '塌菜', '137', '15.00', xhNS.your_domain+'images/201411/goods_img/137_G_1415906148127.jpg']);
_mvq.push(['$logData']);
var _mbausername='';
var _mbauserid='0';
</script>
...
<script type="text/javascript" src="themes/xm2013/js/xm.js"></script><div class="block box">
  <div id="ur_here">
    <div class="ur_here">当前位置: <a href=".">首页</a> <code>&gt;</code> <a href="category.php?id=1">蔬菜类</a> <code>&gt;</code> <a href="category.php?id=11">叶菜类</a> <code>&gt;</code> 塌菜</div>
  </div>
</div>
<div class="blank"></div>
    ...
    <div class="goods-pic-box">
      <div id="goodsInfo" class="clearfix">
        <div class="goods-big-pic">
          <div class="thumb"><img src="images/201411/goods_img/137_G_1415906148127.jpg" alt="塌菜" id="goodsimg" style="cursor:pointer;" onclick="window.open('gallery.php?id=137'); return false;"  /></div>
          <div class="blank5"></div>
          <div class="goods-small-pic clearfix">
            <ul id="imglist">
			              <li class="onbg" lang="images/201411/goods_img/137_P_1415906148940.png"><img src="images/201411/thumb_img/137_thumb_P_1415906148482.jpg" alt="塌菜" /></li>
            ...
            <ul>
              <li class="clearfix">
                <dd class="ddL"><strong>本店售价：</strong><font class="shop" style="font-size:18px;font-weight:bold;" id="ECS_SHOPPRICE">￥15.00元</font></dd>
                                                                                                                                                                   <dd class="ddR"><strong>商品编号：</strong>PV010118</dd>
              </li>
              <li>
              ...
              <li class="clearfix">
                <dd class="ddL"> 商品库存：<font style="color:#FFB03B">10 </font></dd>
                <dd class="ddR"> 商品点击数：<font style="color:#FFB03B; font-weight:bold;"> 146</font>次</dd>
              </li>
...
-->
			...
			function goods_add(){
                ...
                <div class="blank"></div>
                <div class="buyt"><a href="javascript:addToCart(137)"><img src="themes/xm2013/images/bnt_cat1.gif"/></a> &nbsp;&nbsp; <a href="javascript:collect(137)"><img src="themes/xm2013/images/bnt_colles.gif" /></a></div>
              </li>
            </ul>
          </form>
        </div>
...
document.getElementById('history_list').innerHTML = '您已清空最近浏览过的商品';
  ...
  <div class="AreaR xm-box">
    ...
    <div id="com_h" style="overflow:hidden;">
      <blockquote>
        <p>
	<span style="font-size:14px;font-family:SimSun, 宋体, 'Arial Narrow', HELVETICA;color:#333333;line-height:24px;background-color:#ffffff;"></span>
</p>
<p class="MsoNormal" align="left">
	<b><span style="font-size:14px;color:#009900;">产地：君禾园崇明基地</span></b><b><span style="font-size:14px;color:#009900;">         </span></b><b><span style="color:#009900;"><span style="font-size:14px;"></span><span style="font-size:14px;"></span><span style="font-size:14px;"></span><span style="font-size:14px;"> </span></span></b><b><span style="font-size:14px;color:#009900;">储藏方式：低温储藏</span></b><b><span style="font-size:14px;color:#009900;">         </span></b><b><span style="font-size:14px;color:#009900;">产品包装：每份净重</span></b><b><span style="font-size:14px;color:#009900;">350-400</span></b><b><span style="font-size:14px;color:#009900;">克</span></b><b><span style="font-size:14px;color:#009900;">   </span></b> 
</p>
<p class="MsoNormal" align="left">
...
<span style="color:#009900;"></span><span style="font-size:14px;font-family:SimSun, 宋体, 'Arial Narrow', HELVETICA;color:#333333;line-height:24px;background-color:#ffffff;">塌菜为安徽着名特产，是白菜的一个变种，叶色浓绿、肥嫩，因塌地生长而得名。主要分布在我国长江流域，具有分布广、产量高、风味好、供应期长等优点。主要特征是：植株暗绿，叶柄短而扁平，叶片肥厚而有泡皱和刺毛；外叶塌地生长，心叶有不同程度的卷心倾向；耐寒，可露地越冬，冬、春两季均可供应市场；香味浓厚，霜降雪盖后，柔软多汁，糖分增多，品质尤佳，故有“雪下塌菜赛羊肉”的农谚。其品种繁多，主要有黄心乌、黑心乌、宝塔乌、紫乌、白乌、麻乌等。</span> 
<p>
	<br />
</p>
<p>
	<em><em></em></em><span style="font-size:14px;color:#009900;"><strong>营养价值</strong></span> 
</p>
<p>
	<span style="font-size:14px;color:#009900;"></span>
</p>
<p style="font-size:14px;font-family:SimSun, 宋体, 'Arial Narrow', HELVETICA;color:#333333;text-align:justify;background-color:#ffffff;">
	<br />
</p>
<p style="font-size:14px;font-family:SimSun, 宋体, 'Arial Narrow', HELVETICA;color:#333333;text-align:justify;background-color:#ffffff;">
	<span style="line-height:1.5;">1.塌菜秋季播种，以经霜雪后味甜美而着称，被视为白菜中的珍品，因其中含有大量的膳食纤维、钙、铁、维生素C、维生素B1、维生素B2、胡萝卜素等,也被称为“维生素”菜 。</span> 
</p>
<p style="font-size:14px;font-family:SimSun, 宋体, 'Arial Narrow', HELVETICA;color:#333333;text-align:justify;background-color:#ffffff;">
	2.塌菜中的膳食纤维，对防治便秘有很好的作用。
</p>
<p style="font-size:14px;font-family:SimSun, 宋体, 'Arial Narrow', HELVETICA;color:#333333;text-align:justify;background-color:#ffffff;">
	3.祖国医学早在《食物本草》中记载：“塌菜甘、平、无毒。能滑肠、疏肝、利五脏。”
</p>
<p style="font-size:14px;font-family:SimSun, 宋体, 'Arial Narrow', HELVETICA;color:#333333;text-align:justify;background-color:#ffffff;">
	4.常吃塌菜还可以增强人体抗病能力，泽肤健美。
</p>
<p style="font-size:14px;font-family:SimSun, 宋体, 'Arial Narrow', HELVETICA;color:#333333;text-align:justify;background-color:#ffffff;">
	5.塌菜口感清新爽脆，最适合炒食，清炒或加入肉丝、火腿丝一起炒均可。
</p>
<p style="font-size:14px;font-family:SimSun, 宋体, 'Arial Narrow', HELVETICA;color:#333333;text-align:justify;background-color:#ffffff;">
	<br />
</p>
<p style="font-size:14px;font-family:SimSun, 宋体, 'Arial Narrow', HELVETICA;color:#333333;text-align:justify;background-color:#ffffff;">
	<strong><span style="color:#009900;">食疗作用：</span></strong> 
</p>
<p style="font-size:14px;font-family:SimSun, 宋体, 'Arial Narrow', HELVETICA;color:#333333;text-align:justify;background-color:#ffffff;">
	<span style="line-height:1.5;">塌菜味甘、性平，无毒；</span> 
</p>
<p style="font-size:14px;font-family:SimSun, 宋体, 'Arial Narrow', HELVETICA;color:#333333;text-align:justify;background-color:#ffffff;">
	有滑肠、疏肝、利五脏的功效。
</p>
...
<p>
	<br />
      ...
      <blockquote>
        <div class="paddbox">
          <p class="MsoNormal" style="vertical-align:top;background:white;margin-left:0cm;text-indent:-18pt;" align="left">
	<strong><span style="font-size:16px;color:#009900;">清炒塔菜</span></strong> 
</p>
<p class="MsoNormal" style="vertical-align:top;background:white;margin-left:0cm;text-indent:-18pt;" align="center">
	  
</p>
<p class="MsoNormal" style="vertical-align:top;background:white;margin-left:0cm;text-indent:-18pt;" align="left">
	<img alt="" src="http://shop.dream-gardens.com.cn/images/upload/image/20141114/20141114112730_96080.jpg" />
</p>
<p class="MsoNormal" style="vertical-align:top;background:white;margin-left:0cm;text-indent:-18pt;" align="center">
	<br />
</p>
...
<p class="MsoNormal" style="vertical-align:top;background:white;margin-left:0cm;text-indent:-18pt;" align="left">
	   1塔菜掰开，扔掉根茎，冲洗几遍。鲜香菇洗净掰成小瓣，和塔菜一起放筛子里控
</p>
<p class="MsoNormal" style="vertical-align:top;background:white;margin-left:0cm;text-indent:-18pt;" align="left">
	 2小葱切碎备用。
</p>
<p class="MsoNormal" style="vertical-align:top;background:white;margin-left:0cm;text-indent:-18pt;" align="left">
	3锅烧热，倒入油少许，7成热时放入小葱炒出香味。
</p>
<p class="MsoNormal" style="vertical-align:top;background:white;margin-left:0cm;text-indent:-18pt;" align="left">
	4随后将塔菜香菇倒入锅中翻炒。
</p>
<p class="MsoNormal" style="vertical-align:top;background:white;margin-left:0cm;text-indent:-18pt;" align="left">
	5炒至塔菜颜色变亮香菇变软时放入少许盐，翻炒几下，再放入少许糖。
</p>
<p class="MsoNormal" style="vertical-align:top;background:white;margin-left:0cm;text-indent:-18pt;" align="left">
	6炒熟即可关火盛出。<span id="__kindeditor_bookmark_end_6__"></span>
</p>        </div>
      </blockquote>
         </div>
    <script type="text/javascript">
