<?php exit;?>a:3:{s:8:"template";a:5:{i:0;s:35:"D:/WWW/shop/themes/xm2013/goods.dwt";i:1;s:49:"D:/WWW/shop/themes/xm2013/library/page_header.lbi";i:2;s:45:"D:/WWW/shop/themes/xm2013/library/ur_here.lbi";i:3;s:45:"D:/WWW/shop/themes/xm2013/library/history.lbi";i:4;s:49:"D:/WWW/shop/themes/xm2013/library/page_footer.lbi";}s:7:"expires";i:1446897285;s:8:"maketime";i:1446893685;}<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<meta name="Keywords" content="" />
<meta name="Description" content="" />
<title>生姜_调味料类_蔬菜类_君禾园</title>
...
_mvq.push(['$addGoods', '31', '4', '生姜', '100', '8.00', xhNS.your_domain+'images/201505/goods_img/100_G_1431976479262.jpg']);
_mvq.push(['$logData']);
var _mbausername='';
var _mbauserid='0';
</script>
...
<script type="text/javascript" src="themes/xm2013/js/xm.js"></script><div class="block box">
  <div id="ur_here">
    <div class="ur_here">当前位置: <a href=".">首页</a> <code>&gt;</code> <a href="category.php?id=1">蔬菜类</a> <code>&gt;</code> <a href="category.php?id=31">调味料类</a> <code>&gt;</code> 生姜</div>
  </div>
</div>
<div class="blank"></div>
    ...
    <div class="goods-pic-box">
      <div id="goodsInfo" class="clearfix">
        <div class="goods-big-pic">
          <div class="thumb"><img src="images/201505/goods_img/100_G_1431976479262.jpg" alt="生姜" id="goodsimg" style="cursor:pointer;" onclick="window.open('gallery.php?id=100'); return false;"  /></div>
          <div class="blank5"></div>
          <div class="goods-small-pic clearfix">
            <ul id="imglist">
			              <li class="onbg" lang="images/201505/goods_img/100_P_1431976479636.png"><img src="images/201505/thumb_img/100_thumb_P_1431976479155.jpg" alt="生姜" /></li>
...
<script>window._bd_share_config={"common":{"bdSnsKey":{},"bdText":"","bdMini":"2","bdMiniList":false,"bdPic":"","bdStyle":"1","bdSize":"24"},"share":{},"image":{"viewList":["qzone","tqq","tsina","weixin","sqq","renren"],"viewText":"分享到：","viewSize":"16"},"selectShare":{"bdContainerClass":null,"bdSelectMiniList":["qzone","tqq","tsina","weixin","sqq","renren"]}};with(document)0[(getElementsByTagName('head')[0]||body).appendChild(createElement('script')).src='http://bdimg.share.baidu.com/static/api/js/share.js?v=89860593.js?cdnversion='+~(-new Date()/36e5)];</script>
            <ul>
              <li class="clearfix">
                <dd class="ddL"><strong>本店售价：</strong><font class="shop" style="font-size:18px;font-weight:bold;" id="ECS_SHOPPRICE">￥8.00元</font></dd>
                                                                                                                                                                   <dd class="ddR"><strong>商品编号：</strong>ECS000100</dd>
              </li>
              <li>
                <dd class="ddL"><strong>市场价格：</strong><font class="market">￥9.00元</font></dd>
                <dd class="ddR"><strong>商品品牌：</strong><a href="brand.php?id=4" >君禾园</a></dd>
              </li>
              <li class="clearfix">
                <dd class="ddL"> 商品库存：<font style="color:#FFB03B">5 </font></dd>
                <dd class="ddR"> 商品点击数：<font style="color:#FFB03B; font-weight:bold;"> 139</font>次</dd>
              </li>
...
-->
			...
			function goods_add(){
                ...
                <div class="blank"></div>
                <div class="buyt"><a href="javascript:addToCart(100)"><img src="themes/xm2013/images/bnt_cat1.gif"/></a> &nbsp;&nbsp; <a href="javascript:collect(100)"><img src="themes/xm2013/images/bnt_colles.gif" /></a></div>
              </li>
            </ul>
          </form>
        </div>
...
        </span></b><b><span style="color:#009900;font-size:14px;">储藏方式：低温储藏</span></b><b><span style="color:#009900;font-size:14px;">         </span></b><b><span style="color:#009900;font-size:14px;">产品包装：每份净重</span></b><b><span style="color:#009900;font-size:14px;">250</span></b><b><span style="color:#009900;font-size:14px;">克</span></b><b><span style="color:#009900;font-size:14px;">   </span></b> 
</p>
<p class="MsoNormal" align="left">
...
<p class="MsoNormal" align="left">
	<span style="color:#009900;font-size:14px;"><span style="color:#000000;font-family:arial, 宋体, sans-serif;font-size:12px;line-height:24px;background-color:#FFFFFF;">姜经过炮制作为</span><span style="font-size:12px;color:#000000;">中药</span><span style="color:#000000;font-family:arial, 宋体, sans-serif;font-size:12px;line-height:24px;background-color:#FFFFFF;">的药材之一。姜有散寒发汗的功效，所以姜茶可以治疗感冒。它还是日常烹饪常用佐料之一。姜与 </span><span style="font-size:12px;color:#000000;">葱</span><span style="color:#000000;font-family:arial, 宋体, sans-serif;font-size:12px;line-height:24px;background-color:#FFFFFF;">和</span><span style="font-size:12px;color:#000000;">蒜</span><span style="color:#000000;font-family:arial, 宋体, sans-serif;font-size:12px;line-height:24px;background-color:#FFFFFF;">并称为"三大佐料"。</span><span style="font-size:12px;"></span></span> 
</p>
<p class="MsoNormal" align="left">
	<b><span style="color:#009900;font-size:14px;"><br />
</span></b> 
...
<p class="MsoNormal" align="left">
	<span style="color:#009900;font-size:14px;"><span style="color:#000000;font-size:12px;">1.姜含有蛋白质、多种维生素、胡萝卜素、钙、铁、磷。</span></span> 
</p>
<p class="MsoNormal" align="left">
	<span style="color:#009900;font-size:14px;"><span style="color:#000000;font-size:12px;">2.姜中含有姜醇、姜烯、水芹烯、柠檬醛和芳香等油性的挥发油;还有姜辣素、树脂、淀粉和纤维等。</span><span style="color:#000000;"></span></span> 
