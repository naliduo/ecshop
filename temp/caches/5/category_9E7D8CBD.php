    ...
    <div class="xm-box category-list-box"><div class="hd">
        <div class="category-list-order">
          <dl class="xm-filter-list category-order-list clearfix">
            ...
            <dd>
              <ul id="typeSort">
                <li class="default"><a href="category.php?category=1&display=grid&brand=0&price_min=0&price_max=0&filter_attr=0&page=4&sort=goods_id&order=DESC#goods_list"><span class="icon-common icon-order-ascending"></span>按上架时间</a></li>
                <li class="default"><a href="category.php?category=1&display=grid&brand=0&price_min=0&price_max=0&filter_attr=0&page=4&sort=shop_price&order=ASC#goods_list"><span class="icon-common icon-order-ascending"></span>价格由低到高</a></li>
                <li class="DESC"><a href="category.php?category=1&display=grid&brand=0&price_min=0&price_max=0&filter_attr=0&page=4&sort=last_update&order=ASC#goods_list"><span class="icon-common icon-order-ascending"></span>按更新时间排序</a></li>
              </ul>
            </dd>
          </dl>
        </div>
...
var select_spe = "请选择商品属性";
        ...
        <div class="xm-box category-list-box">
          <div class="xm-pagenavi">
		  		  <a class="numbers first" href="category.php?id=1&amp;price_min=0&amp;price_max=0&amp;page=3&amp;sort=last_update&amp;order=DESC">上一页</a>
		  		  
		  		  		  <a class="numbers" href="category.php?id=1&amp;price_min=0&amp;price_max=0&amp;page=1&amp;sort=last_update&amp;order=DESC">1</a>
		  		  		  		  <a class="numbers" href="category.php?id=1&amp;price_min=0&amp;price_max=0&amp;page=2&amp;sort=last_update&amp;order=DESC">2</a>
		  		  		  		  <a class="numbers" href="category.php?id=1&amp;price_min=0&amp;price_max=0&amp;page=3&amp;sort=last_update&amp;order=DESC">3</a>
		  		  		  		  <span class="numbers current"><a href="category.php?id=1&amp;price_min=0&amp;price_max=0&amp;page=4&amp;sort=last_update&amp;order=DESC">4</a></span>
