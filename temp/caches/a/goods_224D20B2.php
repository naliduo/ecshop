...
_mvq.push(['$addGoods', '10', '5', '春笋', '178', '12.00', xhNS.your_domain+'images/201503/goods_img/178_G_1425430610062.jpg']);
_mvq.push(['$logData']);
var _mbausername='';
var _mbauserid='0';
</script>
...
<script type="text/javascript" src="themes/xm2013/js/xm.js"></script><div class="block box">
  <div id="ur_here">
    <div class="ur_here">当前位置: <a href=".">首页</a> <code>&gt;</code> <a href="category.php?id=1">蔬菜类</a> <code>&gt;</code> <a href="category.php?id=10">根菜类</a> <code>&gt;</code> 春笋</div>
  </div>
</div>
<div class="blank"></div>
    ...
    <div class="goods-pic-box">
      <div id="goodsInfo" class="clearfix">
        <div class="goods-big-pic">
          <div class="thumb"><img src="images/201503/goods_img/178_G_1425430610062.jpg" alt="春笋" id="goodsimg" style="cursor:pointer;" onclick="window.open('gallery.php?id=178'); return false;"  /></div>
          <div class="blank5"></div>
          <div class="goods-small-pic clearfix">
            <ul id="imglist">
			              <li class="onbg" lang="images/201503/goods_img/178_P_1425430610820.png"><img src="images/201503/thumb_img/178_thumb_P_1425430610225.jpg" alt="春笋" /></li>
...
<script>window._bd_share_config={"common":{"bdSnsKey":{},"bdText":"","bdMini":"2","bdMiniList":false,"bdPic":"","bdStyle":"1","bdSize":"24"},"share":{},"image":{"viewList":["qzone","tqq","tsina","weixin","sqq","renren"],"viewText":"分享到：","viewSize":"16"},"selectShare":{"bdContainerClass":null,"bdSelectMiniList":["qzone","tqq","tsina","weixin","sqq","renren"]}};with(document)0[(getElementsByTagName('head')[0]||body).appendChild(createElement('script')).src='http://bdimg.share.baidu.com/static/api/js/share.js?v=89860593.js?cdnversion='+~(-new Date()/36e5)];</script>
            <ul>
              <li class="clearfix">
                <dd class="ddL"><strong>本店售价：</strong><font class="shop" style="font-size:18px;font-weight:bold;" id="ECS_SHOPPRICE">￥12.00元</font></dd>
                                                                                                                                                                   <dd class="ddR"><strong>商品编号：</strong>BV010306</dd>
              </li>
              <li>
                <dd class="ddL"><strong>市场价格：</strong><font class="market">￥13.00元</font></dd>
                <dd class="ddR"><strong>商品品牌：</strong><a href="brand.php?id=5" >其它品牌</a></dd>
              </li>
              <li class="clearfix">
                <dd class="ddL"> 商品库存：<font style="color:#FFB03B">缺货</font></dd>
                <dd class="ddR"> 商品点击数：<font style="color:#FFB03B; font-weight:bold;"> 121</font>次</dd>
              </li>
...
-->
			...
			function goods_add(){
                ...
                <div class="blank"></div>
                <div class="buyt"><a href="javascript:addToCart(178)"><img src="themes/xm2013/images/bnt_cat1.gif"/></a> &nbsp;&nbsp; <a href="javascript:collect(178)"><img src="themes/xm2013/images/bnt_colles.gif" /></a></div>
              </li>
            </ul>
          </form>
        </div>
...
<p class="MsoNormal" align="left">
	<b><span style="color:#006600;font-size:14px;">产地：君禾园崇明基地</span></b><b><span style="color:#006600;font-size:14px;"> 
        </span></b><b><span style="color:#006600;font-size:14px;">储藏方式：低温储藏</span></b><b><span style="color:#006600;font-size:14px;">         </span></b><b><span style="color:#006600;font-size:14px;">产品包装：每份净重5</span></b><b><span style="color:#006600;font-size:14px;">00</span></b><b><span style="color:#006600;font-size:14px;">克</span></b><b><span style="color:#006600;font-size:14px;">   </span></b> 
</p>
<p class="MsoNormal" align="left">
	<b><br />
</b> 
...
<p class="MsoNormal" align="left">
	<b><span style="color:#006600;font-size:14px;">商品详情</span></b> 
</p>
<span style="color:#006600;font-size:14px;background-color:#006600;"></span><span style="line-height:1.5;">春笋味道清淡鲜嫩，营养丰富,含有充足的水分、丰富的植物蛋白以及钙、磷、铁等人体必需的营养成分和微量元素，特别是纤维素含量很高，常食有帮助消化、防止便秘的功能。                                                                                                                          </span> 
<p>
	<br />
</p>
<p>
	<strong><span style="color:#006600;font-size:14px;">营养价值        </span></strong>                                                                                           
</p>
<p>
	<span style="line-height:1.5;">1、化痰止咳：对咽喉部有良好的湿润和物理治疗作用，有利于局部炎症治愈，并能解除局部痒感，从而阻断咳嗽反射。</span> 
</p>
<p>
	<span style="line-height:1.5;">2、消食：有助于胃酸的分泌和食物的消化，宜于治疗饮食积滞证。</span> 
</p>
<p>
...
6、养颜护肤：含有胡萝卜素，有助于维持皮肤细胞组织正常机能，刺激皮肤新陈代谢，保持皮肤润泽细嫩.    <br />        <div class="blank"></div>
      ...
      <blockquote>
        <div class="paddbox">
          <p>
	<span style="color:#006600;font-size:16px;"><strong>油闷春笋    </strong></span>                                                                                              
</p>
<p>
	<img src="/images/upload/image/20150304/20150304133858_65659.jpg" alt="" /> 
</p>
<p>
	<br />
</p>
<p>
	春笋200克，酱油25克，白砂糖20克，盐5克，植物油50克。  
</p>
<p>
	<span style="line-height:1.5;">1、春笋切成5厘米长的条，把油锅烧至七成热，将春笋倒入拉油至春笋水分基本收干后倒</span> 
</p>
<p>
	<span style="line-height:1.5;">2、锅留底油烧热倒入春笋，再加老抽，糖，味精和适量水，用小火焖烧至水分基本收干后，淋些明油装盘即可。</span> 
</p>        </div>
      </blockquote>
         </div>
    <script type="text/javascript">
