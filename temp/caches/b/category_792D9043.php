    ...
    <div class="xm-box category-list-box"><div class="hd">
        <div class="category-list-order">
          <dl class="xm-filter-list category-order-list clearfix">
            ...
            <dd>
              <ul id="typeSort">
                <li class="DESC"><a href="category.php?category=1&display=grid&brand=0&price_min=0&price_max=0&filter_attr=0&page=4&sort=goods_id&order=ASC#goods_list"><span class="icon-common icon-order-ascending"></span>按上架时间</a></li>
                ...
                <li class="default"><a href="category.php?category=1&display=grid&brand=0&price_min=0&price_max=0&filter_attr=0&page=4&sort=last_update&order=DESC#goods_list"><span class="icon-common icon-order-ascending"></span>按更新时间排序</a></li>
              </ul>
            </dd>
          </dl>
        </div>
          ...
          <ul class="xm-goods-list clearfix">
              ...
              <div class="xm-goods-item">
                ...
                <div class="item-flags"><span class="icon-saleoff icon-saleoff-0"></span></div>
                                ...
                                <li>
              <div class="xm-goods-item">
                <div class="item-thumb"><a href="goods.php?id=28" title="韭菜"><img src="images/201505/thumb_img/28_thumb_G_1431976778269.jpg" alt="韭菜" /></a></div>
                <h2 class="item-name"><a href="goods.php?id=28" title="韭菜">韭菜</a></h2>
                <div class="item-price">￥15.00元<del>￥17.00元</del></div>
                <div class="item-action"><a class="action-add-cart xmAddShopCart" href="javascript:addToCart(28)" ><span class="icon-common icon-common-plus"></span>加入购物车</a></div>
                <div class="item-flags"><span class="icon-saleoff icon-saleoff-0"></span></div>
              </div>
            </li>
...
var select_spe = "请选择商品属性";
        ...
        <div class="xm-box category-list-box">
          <div class="xm-pagenavi">
		  		  <a class="numbers first" href="category.php?id=1&amp;price_min=0&amp;price_max=0&amp;page=3&amp;sort=goods_id&amp;order=DESC">上一页</a>
		  		  
		  		  		  <a class="numbers" href="category.php?id=1&amp;price_min=0&amp;price_max=0&amp;page=1&amp;sort=goods_id&amp;order=DESC">1</a>
		  		  		  		  ...
		  		  		  		  <span class="numbers current"><a href="category.php?id=1&amp;price_min=0&amp;price_max=0&amp;page=4&amp;sort=goods_id&amp;order=DESC">4</a></span>
