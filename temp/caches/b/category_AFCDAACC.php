  ...
  <div class="span12">
    ...
    <div class="xm-box category-filter-box">
      <div class="hd">
        ...
        <div class="category-filter-meta">共25个商品</div>
      </div>
	        <div class="bd">
          ...
          <dd>
            <ul>
											<li><a href="category.php?id=11&amp;price_min=0&amp;price_max=0">全部</a></li>
    ...
    <div class="xm-box category-list-box"><div class="hd">
        <div class="category-list-order">
          <dl class="xm-filter-list category-order-list clearfix">
            ...
            <dd>
              <ul id="typeSort">
                <li class="default"><a href="category.php?category=11&display=grid&brand=4&price_min=0&price_max=0&filter_attr=0&page=2&sort=goods_id&order=DESC#goods_list"><span class="icon-common icon-order-ascending"></span>按上架时间</a></li>
                <li class="default"><a href="category.php?category=11&display=grid&brand=4&price_min=0&price_max=0&filter_attr=0&page=2&sort=shop_price&order=ASC#goods_list"><span class="icon-common icon-order-ascending"></span>价格由低到高</a></li>
                <li class="ASC"><a href="category.php?category=11&display=grid&brand=4&price_min=0&price_max=0&filter_attr=0&page=2&sort=last_update&order=DESC#goods_list"><span class="icon-common icon-order-ascending"></span>按更新时间排序</a></li>
              </ul>
            </dd>
          </dl>
        </div>
        ...
        <div class="xm-goods-list-wrap">
          <ul class="xm-goods-list clearfix">
              ...
              <div class="xm-goods-item">
                <div class="item-thumb"><a href="goods.php?id=31" title="白凤菜"><img src="images/201409/thumb_img/31_thumb_G_1410738644384.jpg" alt="白凤菜" /></a></div>
                <h2 class="item-name"><a href="goods.php?id=31" title="白凤菜">白凤菜</a></h2>
                <div class="item-price">￥15.00元<del>￥17.25元</del></div>
                <div class="item-action"><a class="action-add-cart xmAddShopCart" href="javascript:addToCart(31)" ><span class="icon-common icon-common-plus"></span>加入购物车</a></div>
...
var select_spe = "请选择商品属性";
        ...
        <div class="xm-box category-list-box">
          <div class="xm-pagenavi">
		  		  <a class="numbers first" href="category.php?id=11&amp;brand=4&amp;price_min=0&amp;price_max=0&amp;page=1&amp;sort=last_update&amp;order=ASC">上一页</a>
		  		  
		  		  		  <a class="numbers" href="category.php?id=11&amp;brand=4&amp;price_min=0&amp;price_max=0&amp;page=1&amp;sort=last_update&amp;order=ASC">1</a>
		  		  		  		  <span class="numbers current"><a href="category.php?id=11&amp;brand=4&amp;price_min=0&amp;price_max=0&amp;page=2&amp;sort=last_update&amp;order=ASC">2</a></span>
		  		  		  		  <a class="numbers" href="category.php?id=11&amp;brand=4&amp;price_min=0&amp;price_max=0&amp;page=3&amp;sort=last_update&amp;order=ASC">3</a>
		  		  		  		  <a class="numbers last" href="category.php?id=11&amp;brand=4&amp;price_min=0&amp;price_max=0&amp;page=3&amp;sort=last_update&amp;order=ASC">下一页</a>
		  		  </div>
        </div>
      </form></div>
  </div>
