...
_mvq.push(['$addGoods', '28', '4', '崇明豇豆', '48', '15.00', xhNS.your_domain+'images/201409/goods_img/48_G_1410723567496.jpg']);
_mvq.push(['$logData']);
var _mbausername='';
var _mbauserid='0';
</script>
...
<script type="text/javascript" src="themes/xm2013/js/xm.js"></script><div class="block box">
  <div id="ur_here">
    <div class="ur_here">当前位置: <a href=".">首页</a> <code>&gt;</code> <a href="category.php?id=29">瓜果豆类</a> <code>&gt;</code> <a href="category.php?id=28">豆类</a> <code>&gt;</code> 崇明豇豆</div>
  </div>
</div>
<div class="blank"></div>
    ...
    <div class="goods-pic-box">
      <div id="goodsInfo" class="clearfix">
        <div class="goods-big-pic">
          <div class="thumb"><img src="images/201409/goods_img/48_G_1410723567496.jpg" alt="崇明豇豆" id="goodsimg" style="cursor:pointer;" onclick="window.open('gallery.php?id=48'); return false;"  /></div>
          <div class="blank5"></div>
          <div class="goods-small-pic clearfix">
            <ul id="imglist">
			              <li class="onbg" lang="images/201409/goods_img/48_P_1410723567635.jpg"><img src="images/201409/thumb_img/48_thumb_P_1410723567207.jpg" alt="崇明豇豆" /></li>
            ...
            <ul>
              <li class="clearfix">
                <dd class="ddL"><strong>本店售价：</strong><font class="shop" style="font-size:18px;font-weight:bold;" id="ECS_SHOPPRICE">￥15.00元</font></dd>
                                                                                                                                                                   <dd class="ddR"><strong>商品编号：</strong>PV010402</dd>
              </li>
              <li>
                <dd class="ddL"><strong>市场价格：</strong><font class="market">￥17.25元</font></dd>
                <dd class="ddR"><strong>商品品牌：</strong><a href="brand.php?id=4" >君禾园</a></dd>
              </li>
              <li class="clearfix">
                <dd class="ddL"> 商品库存：<font style="color:#FFB03B">缺货</font></dd>
                <dd class="ddR"> 商品点击数：<font style="color:#FFB03B; font-weight:bold;"> 129</font>次</dd>
              </li>
...
-->
			...
			function goods_add(){
                ...
                <div class="blank"></div>
                <div class="buyt"><a href="javascript:addToCart(48)"><img src="themes/xm2013/images/bnt_cat1.gif"/></a> &nbsp;&nbsp; <a href="javascript:collect(48)"><img src="themes/xm2013/images/bnt_colles.gif" /></a></div>
              </li>
            </ul>
          </form>
        </div>
...
document.getElementById('history_list').innerHTML = '您已清空最近浏览过的商品';
  ...
  <div class="AreaR xm-box">
    ...
    <div id="com_h" style="overflow:hidden;">
      <blockquote>
        <p>
	<span style="color:#009900;font-family:宋体;font-size:14px;"><strong></strong></span> <span style="color:#009900;font-family:宋体;font-size:14px;"><strong>产地：君禾园崇明基地</strong></span><span style="color:#009900;font-size:14px;"><span style="color:#009900;font-size:14px;"><strong>                 </strong></span></span><span style="color:#009900;font-family:宋体;font-size:14px;"><strong>储藏方法：低温储藏</strong></span><span style="color:#009900;font-size:14px;"><span style="color:#009900;font-size:14px;"><strong>             </strong></span></span><span style="color:#009900;font-family:宋体;font-size:14px;"><strong>产品包装：每份净重350-4</strong></span><span style="color:#009900;font-size:14px;"><strong>00</strong></span><span style="color:#009900;font-family:宋体;font-size:14px;"><strong>克</strong></span> 
</p>
<p>
	<br />
</p>
<p>
	<strong><span style="color:#009900;font-size:14px;">商品详情</span></strong> 
</p>
<p>
	<span style="color:#000000;background-color:#FFFFFF;">君禾园种植的豇豆品种是崇明长豇豆。它除了有健脾、和胃的作用外，最重要的是能够补肾。李时珍曾称赞它能够理中益气，补肾健胃，和五脏，调营卫，生精髓。所谓营卫就是中医所说的营卫二气，调整好了，可充分保证人的睡眠质量。此外，多吃豇豆还能治疗呕吐、打嗝等不适。小孩食积、气胀的时候，用生豇豆适量，细嚼后咽下，可以起到一定的缓解作用。</span> 
</p>
<p>
	<span style="color:#000000;font-size:14px;"><strong> </strong></span> 
</p>
<p>
	<span style="color:#000000;"></span><span style="color:#009900;font-size:14px;"><strong>营养价值</strong></span> 
</p>
<p>
	对尿频、遗精及一些妇科功能性疾病有辅助功效。豇豆含有易为人体所吸收的优质蛋白质，一定量的碳水化合物、维生素以及钙、磷、铁等矿物质，有利于人体新陈代谢；豇豆所含B族维生素能使机体保持正常的消化腺分泌和胃肠道蠕动的功能，平衡胆碱酯酶活性，有帮助消化、增进食欲的功效；所含维生素C能促进抗体的合成，抑制病毒，提高机体的免疫能力。
</p>
<p>
	<br />
</p>
<p>
	<span style="color:#009900;font-size:14px;background-color:#FFFFFF;"><strong>食用禁忌</strong></span> 
</p>
<p>
	<span style="color:#333333;background-color:#FFFFFF;">气滞便结者应慎食豇豆;豇豆要烹饪热透食用，不熟豆角易导致腹泻、中毒。</span> 
</p>
<p>
	<br />
	...
	<img src="/images/upload/image/20141014/20141014164831_64558.jpg" alt="" /><span style="line-height:1.5;"></span>
</div>        </div>
      </blockquote>
      
      <blockquote>
        <div class="paddbox">
          <p style="background:#FFFFFF;color:#666666;text-indent:0px;vertical-align:baseline;">
	<strong><span style="color:#009900;font-size:14px;">姜汁豇豆</span></strong> 
</p>
<img alt="" src="/images/upload/image/20140916/20140916113201_49771.jpg" /> 
<p style="background:#FFFFFF;color:#666666;text-indent:0px;vertical-align:baseline;">
	<br />
</p>
<p style="background:#FFFFFF;color:#666666;text-indent:0px;vertical-align:baseline;">
	<span style="color:#000000;">1将嫩豇豆摘去老筋，洗净沥干，切成4厘米左右的长段：</span> 
</p>
<p style="background:#FFFFFF;color:#666666;text-indent:0px;vertical-align:baseline;">
	<em class="step"><span style="color:#000000;">2.</span></em><span style="color:#000000;">在沸水中放入少许盐和油，将豇豆焯熟，煮时不要加盖，捞出沥干待用：</span> 
</p>
<p style="background:#FFFFFF;color:#666666;text-indent:0px;vertical-align:baseline;">
	<em class="step"><span style="color:#000000;">3.</span></em><span style="color:#000000;">将姜用工具擦成泥，或者用搅拌机打成泥</span> 
</p>
<p style="background:#FFFFFF;color:#666666;text-indent:0px;vertical-align:baseline;">
	<em class="step"><span style="color:#000000;">4.</span></em><span style="color:#000000;">用姜泥和调料将豇豆拌匀，装盘即可</span> 
</p>
<p style="background:#FFFFFF;color:#666666;text-indent:0px;vertical-align:baseline;">
	<br />
</p>
