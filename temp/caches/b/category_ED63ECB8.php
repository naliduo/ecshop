    ...
    <div class="xm-box">
      ...
      <div class="bd">
        <ul class="xm-goods-sublist xm-goods-sublist-l">
		          <li>
            <div class="item-name"><a href="goods.php?id=131" title="大米（2015年新米）">大米（2015年新米）</a></div>
            <div class="item-price">￥35.00元</div>
            <div class="item-thumb"><a href="goods.php?id=131" title="大米（2015年新米）"><img src="images/201411/thumb_img/131_thumb_G_1414970999207.jpg" alt="大米（2015年新米）" /></a></div>
          </li>
               </ul>
      </div>
    </div>
  ...
  <div class="span12">
    ...
    <div class="xm-box category-filter-box">
      <div class="hd">
        ...
        <div class="category-filter-meta">共10个商品</div>
      </div>
	        <div class="bd">
          ...
          <dd>
            <ul>
											<li class="current"><a>全部</a></li>
																<li><a href="category.php?id=2&amp;brand=4&amp;price_min=0&amp;price_max=0">君禾园</a></li>
																<li><a href="category.php?id=2&amp;brand=5&amp;price_min=0&amp;price_max=0">其它品牌</a></li>
								            </ul>
          </dd>
        </dl>
    ...
    <div class="xm-box category-list-box"><div class="hd">
        <div class="category-list-order">
          <dl class="xm-filter-list category-order-list clearfix">
            ...
            <dd>
              <ul id="typeSort">
                <li class="ASC"><a href="category.php?category=2&display=grid&brand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=goods_id&order=DESC#goods_list"><span class="icon-common icon-order-ascending"></span>按上架时间</a></li>
                <li class="default"><a href="category.php?category=2&display=grid&brand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=shop_price&order=ASC#goods_list"><span class="icon-common icon-order-ascending"></span>价格由低到高</a></li>
                <li class="default"><a href="category.php?category=2&display=grid&brand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=last_update&order=DESC#goods_list"><span class="icon-common icon-order-ascending"></span>按更新时间排序</a></li>
              </ul>
            </dd>
          </dl>
        </div>
          ...
          <ul class="xm-goods-list clearfix">
              ...
              <div class="xm-goods-item">
                ...
                <div class="item-flags"><span class="icon-saleoff icon-saleoff-0"></span></div>
                                ...
                                <li>
              <div class="xm-goods-item">
                <div class="item-thumb"><a href="goods.php?id=61" title="红皮花生仁"><img src="images/201409/thumb_img/61_thumb_G_1410718950372.jpg" alt="红皮花生仁" /></a></div>
                <h2 class="item-name"><a href="goods.php?id=61" title="红皮花生仁">红皮花生仁</a></h2>
                <div class="item-price">￥15.00元<del>￥17.00元</del></div>
                <div class="item-action"><a class="action-add-cart xmAddShopCart" href="javascript:addToCart(61)" ><span class="icon-common icon-common-plus"></span>加入购物车</a></div>
                <div class="item-flags"><span class="icon-saleoff icon-saleoff-0">热销</span></div>
              </div>
            </li>
                                <li>
              <div class="xm-goods-item">
                <div class="item-thumb"><a href="goods.php?id=62" title="绿豆"><img src="images/201409/thumb_img/62_thumb_G_1410718412135.jpg" alt="绿豆" /></a></div>
                <h2 class="item-name"><a href="goods.php?id=62" title="绿豆">绿豆</a></h2>
                <div class="item-price">￥16.68元<del>￥19.00元</del></div>
                <div class="item-action"><a class="action-add-cart xmAddShopCart" href="javascript:addToCart(62)" ><span class="icon-common icon-common-plus"></span>加入购物车</a></div>
                <div class="item-flags"><span class="icon-saleoff icon-saleoff-0"></span></div>
              </div>
            </li>
                                <li>
              <div class="xm-goods-item">
                <div class="item-thumb"><a href="goods.php?id=63" title="黑芝麻"><img src="images/201409/thumb_img/63_thumb_G_1410718309968.jpg" alt="黑芝麻" /></a></div>
                <h2 class="item-name"><a href="goods.php?id=63" title="黑芝麻">黑芝麻</a></h2>
                <div class="item-price">￥16.68元<del>￥19.00元</del></div>
                <div class="item-action"><a class="action-add-cart xmAddShopCart" href="javascript:addToCart(63)" ><span class="icon-common icon-common-plus"></span>加入购物车</a></div>
                <div class="item-flags"><span class="icon-saleoff icon-saleoff-0">新品</span></div>
              </div>
            </li>
                                <li>
              <div class="xm-goods-item">
                <div class="item-thumb"><a href="goods.php?id=64" title="赤豆"><img src="images/201409/thumb_img/64_thumb_G_1410718016082.jpg" alt="赤豆" /></a></div>
                <h2 class="item-name"><a href="goods.php?id=64" title="赤豆">赤豆</a></h2>
                <div class="item-price">￥13.50元<del>￥15.00元</del></div>
                <div class="item-action"><a class="action-add-cart xmAddShopCart" href="javascript:addToCart(64)" ><span class="icon-common icon-common-plus"></span>加入购物车</a></div>
                <div class="item-flags"><span class="icon-saleoff icon-saleoff-0"></span></div>
              </div>
            </li>
                                <li>
              ...
              <div class="xm-goods-item">
                <div class="item-thumb"><a href="goods.php?id=131" title="大米（2015年新米）"><img src="images/201411/thumb_img/131_thumb_G_1414970999207.jpg" alt="大米（2015年新米）" /></a></div>
                <h2 class="item-name"><a href="goods.php?id=131" title="大米（2015年新米）">大米（2015年新米）</a></h2>
                <div class="item-price">￥35.00元<del>￥40.25元</del></div>
                <div class="item-action"><a class="action-add-cart xmAddShopCart" href="javascript:addToCart(131)" ><span class="icon-common icon-common-plus"></span>加入购物车</a></div>
                <div class="item-flags"><span class="icon-saleoff icon-saleoff-0">新品</span></div>
              </div>
            </li>
        ...
        <div class="xm-box category-list-box">
          <div class="xm-pagenavi">
		  		  <span class="numbers first">上一页</span>
		  		  		  ...
		  		  		  <span class="numbers current"><a href="category.php?id=2&amp;price_min=0&amp;price_max=0&amp;page=1&amp;sort=goods_id&amp;order=ASC">1</a></span>
