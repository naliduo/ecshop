          ...
          <dl class="xm-filter-list category-order-list clearfix">
            ...
            <dd>
              <ul id="typeSort">
                ...
                <li class="ASC"><a href="brand.php?category=0&display=grid&brand=4&price_min=&price_max=&filter_attr=&page=1&sort=shop_price&order=DESC#goods_list"><span class="icon-common icon-order-ascending"></span>价格由低到高</a></li>
        ...
        <div class="xm-goods-list-wrap">
          <ul class="xm-goods-list clearfix">
              ...
              <div class="xm-goods-item">
                <div class="item-thumb"><a href="goods.php?id=141" title="小礼盒"><img src="images/201411/thumb_img/141_thumb_G_1416350063710.jpg" alt="小礼盒" /></a></div>
                <h2 class="item-name"><a href="goods.php?id=141" title="小礼盒">小礼盒</a></h2>
                <div class="item-price">￥1.00元<del>￥0.00元</del></div>
                <div class="item-action"><a class="action-add-cart xmAddShopCart" href="javascript:addToCart(141)" ><span class="icon-common icon-common-plus"></span>加入购物车</a></div>
              ...
              <div class="xm-goods-item">
                ...
                <div class="item-action"><a class="action-add-cart xmAddShopCart" href="javascript:addToCart(101)" ><span class="icon-common icon-common-plus"></span>加入购物车</a></div>
                                ...
                                <li>
              <div class="xm-goods-item">
                <div class="item-thumb"><a href="goods.php?id=180" title="香菜"><img src="images/201503/thumb_img/180_thumb_G_1427135013667.jpg" alt="香菜" /></a></div>
                <h2 class="item-name"><a href="goods.php?id=180" title="香菜">香菜</a></h2>
                <div class="item-price">￥6.00元<del>￥6.90元</del></div>
                <div class="item-action"><a class="action-add-cart xmAddShopCart" href="javascript:addToCart(180)" ><span class="icon-common icon-common-plus"></span>加入购物车</a></div>
              ...
              <div class="xm-goods-item">
                ...
                <div class="item-action"><a class="action-add-cart xmAddShopCart" href="javascript:addToCart(219)" ><span class="icon-common icon-common-plus"></span>加入购物车</a></div>
                                ...
                                <li>
              <div class="xm-goods-item">
                <div class="item-thumb"><a href="goods.php?id=50" title="黄秋葵"><img src="images/201409/thumb_img/50_thumb_G_1410723194498.jpg" alt="黄秋葵" /></a></div>
                <h2 class="item-name"><a href="goods.php?id=50" title="黄秋葵">黄秋葵</a></h2>
                <div class="item-price">￥9.50元<del>￥10.93元</del></div>
                <div class="item-action"><a class="action-add-cart xmAddShopCart" href="javascript:addToCart(50)" ><span class="icon-common icon-common-plus"></span>加入购物车</a></div>
               
              </div>
            </li>
                                <li>
              <div class="xm-goods-item">
                <div class="item-thumb"><a href="goods.php?id=148" title="小叶苦苣"><img src="images/201412/thumb_img/148_thumb_G_1417389735588.jpg" alt="小叶苦苣" /></a></div>
                <h2 class="item-name"><a href="goods.php?id=148" title="小叶苦苣">小叶苦苣</a></h2>
                <div class="item-price">￥11.50元<del>￥13.23元</del></div>
                <div class="item-action"><a class="action-add-cart xmAddShopCart" href="javascript:addToCart(148)" ><span class="icon-common icon-common-plus"></span>加入购物车</a></div>
              ...
              <div class="xm-goods-item">
                ...
                <div class="item-action"><a class="action-add-cart xmAddShopCart" href="javascript:addToCart(125)" ><span class="icon-common icon-common-plus"></span>加入购物车</a></div>
                                ...
                                <li>
              <div class="xm-goods-item">
                <div class="item-thumb"><a href="goods.php?id=163" title="糖桂花"><img src="images/201501/thumb_img/163_thumb_G_1421795441147.jpg" alt="糖桂花" /></a></div>
                <h2 class="item-name"><a href="goods.php?id=163" title="糖桂花">糖桂花</a></h2>
                <div class="item-price">￥12.00元<del>￥13.00元</del></div>
                <div class="item-action"><a class="action-add-cart xmAddShopCart" href="javascript:addToCart(163)" ><span class="icon-common icon-common-plus"></span>加入购物车</a></div>
               
              </div>
            </li>
                                <li>
              <div class="xm-goods-item">
                <div class="item-thumb"><a href="goods.php?id=118" title="黄豆"><img src="images/201410/thumb_img/118_thumb_G_1413826800653.jpg" alt="黄豆" /></a></div>
                <h2 class="item-name"><a href="goods.php?id=118" title="黄豆">黄豆</a></h2>
                <div class="item-price">￥13.50元<del>￥15.00元</del></div>
                <div class="item-action"><a class="action-add-cart xmAddShopCart" href="javascript:addToCart(118)" ><span class="icon-common icon-common-plus"></span>加入购物车</a></div>
        ...
        <div class="xm-box category-list-box">
          <div class="xm-pagenavi">
		  		  <span class="numbers first">上一页</span>
		  		  		  ...
		  		  		  <span class="numbers current"><a href="brand.php?id=4&amp;page=1&amp;sort=shop_price&amp;order=ASC">1</a></span>
		  		  		  		  <a class="numbers" href="brand.php?id=4&amp;page=2&amp;sort=shop_price&amp;order=ASC">2</a>
		  		  		  		  <a class="numbers" href="brand.php?id=4&amp;page=3&amp;sort=shop_price&amp;order=ASC">3</a>
		  		  		  		  <a class="numbers" href="brand.php?id=4&amp;page=4&amp;sort=shop_price&amp;order=ASC">4</a>
		  		  		  		  <a class="numbers" href="brand.php?id=4&amp;page=5&amp;sort=shop_price&amp;order=ASC">5</a>
		  		  		  		  <a class="numbers" href="brand.php?id=4&amp;page=6&amp;sort=shop_price&amp;order=ASC">6</a>
		  		  		  		  <a class="numbers" href="brand.php?id=4&amp;page=7&amp;sort=shop_price&amp;order=ASC">7</a>
		  		  		  		  <a class="numbers last" href="brand.php?id=4&amp;page=2&amp;sort=shop_price&amp;order=ASC">下一页</a>
		  		  </div>
        </div>
      </form></div>
  </div>  
