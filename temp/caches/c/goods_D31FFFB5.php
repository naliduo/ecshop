<?php exit;?>a:3:{s:8:"template";a:5:{i:0;s:35:"D:/WWW/shop/themes/xm2013/goods.dwt";i:1;s:49:"D:/WWW/shop/themes/xm2013/library/page_header.lbi";i:2;s:45:"D:/WWW/shop/themes/xm2013/library/ur_here.lbi";i:3;s:45:"D:/WWW/shop/themes/xm2013/library/history.lbi";i:4;s:49:"D:/WWW/shop/themes/xm2013/library/page_footer.lbi";}s:7:"expires";i:1446897163;s:8:"maketime";i:1446893563;}<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<meta name="Keywords" content="" />
<meta name="Description" content="" />
<title>荠菜_叶菜类_蔬菜类_君禾园</title>
...
_mvq.push(['$addGoods', '11', '4', '荠菜', '129', '16.80', xhNS.your_domain+'images/201410/goods_img/129_G_1414693429846.jpg']);
_mvq.push(['$logData']);
var _mbausername='';
var _mbauserid='0';
</script>
...
<script type="text/javascript" src="themes/xm2013/js/xm.js"></script><div class="block box">
  <div id="ur_here">
    <div class="ur_here">当前位置: <a href=".">首页</a> <code>&gt;</code> <a href="category.php?id=1">蔬菜类</a> <code>&gt;</code> <a href="category.php?id=11">叶菜类</a> <code>&gt;</code> 荠菜</div>
  </div>
</div>
<div class="blank"></div>
    ...
    <div class="goods-pic-box">
      <div id="goodsInfo" class="clearfix">
        <div class="goods-big-pic">
          <div class="thumb"><img src="images/201410/goods_img/129_G_1414693429846.jpg" alt="荠菜" id="goodsimg" style="cursor:pointer;" onclick="window.open('gallery.php?id=129'); return false;"  /></div>
          <div class="blank5"></div>
          <div class="goods-small-pic clearfix">
            <ul id="imglist">
			              <li class="onbg" lang="images/201410/goods_img/129_P_1414693429803.png"><img src="images/201410/thumb_img/129_thumb_P_1414693429526.jpg" alt="荠菜" /></li>
        ...
        <div class="textInfo">
          <form action="javascript:addToCart(129)" method="post" name="ECS_FORMBUY" id="ECS_FORMBUY" >
            ...
            <ul>
              <li class="clearfix">
                <dd class="ddL"><strong>本店售价：</strong><font class="shop" style="font-size:18px;font-weight:bold;" id="ECS_SHOPPRICE">￥16.80元</font></dd>
                                                                                                                                                                   <dd class="ddR"><strong>商品编号：</strong>PV010119</dd>
              </li>
              <li>
              ...
              <li class="clearfix">
                <dd class="ddL"> 商品库存：<font style="color:#FFB03B">8 </font></dd>
                <dd class="ddR"> 商品点击数：<font style="color:#FFB03B; font-weight:bold;"> 196</font>次</dd>
              </li>
...
-->
			...
			function goods_add(){
                ...
                <div class="blank"></div>
                <div class="buyt"><a href="javascript:addToCart(129)"><img src="themes/xm2013/images/bnt_cat1.gif"/></a> &nbsp;&nbsp; <a href="javascript:collect(129)"><img src="themes/xm2013/images/bnt_colles.gif" /></a></div>
              </li>
            </ul>
          </form>
        </div>
...
document.getElementById('history_list').innerHTML = '您已清空最近浏览过的商品';
  ...
  <div class="AreaR xm-box">
    ...
    <div id="com_h" style="overflow:hidden;">
      <blockquote>
         <b><span style="font-size:14px;font-family:宋体;color:#009900;">产地：君禾园崇明基地</span></b><b><span style="FONT-SIZE: 14px; FONT-FAMILY: " tahoma?,?sans-serif?;color:#009900;?="">          </span></b><b><span style="font-size:14px;font-family:宋体;color:#009900;">储藏方式：低温储藏</span></b><b><span style="FONT-SIZE: 14px; FONT-FAMILY: " tahoma?,?sans-serif?;color:#009900;?="">         </span></b><b><span style="font-size:14px;font-family:宋体;color:#009900;">产品包装：每份净重</span></b><b><span style="FONT-SIZE: 14px; FONT-FAMILY: ; COLOR: #009900" tahoma?,?sans-serif?;color:#009900;?="">350-400</span></b><b><span style="font-size:14px;font-family:宋体;color:#009900;">克</span></b><b><span style="FONT-SIZE: 14px; FONT-FAMILY: " tahoma?,?sans-serif?;color:#009900;?="">   </span></b><span style="FONT-SIZE: 9pt; FONT-FAMILY: " tahoma?,?sans-serif?;color:black;?=""></span> 
...
<p>
	<span style="color:#000000;background-color:#ffffff;">地方上叫</span><span style="color:#000000;">香荠</span><span style="color:#000000;background-color:#ffffff;">，北方也叫</span><span style="color:#000000;">白花菜</span><span style="color:#000000;background-color:#ffffff;">,黑心菜，瑶家叫“禾杆菜″，</span><span style="color:#000000;">河南</span><span style="color:#000000;background-color:#ffffff;">、湖北等地区叫地菜，是一种人们喜爱的可食用</span><span style="color:#000000;">野菜</span><span style="color:#000000;background-color:#ffffff;">。</span>
</p>
<p>
	<span style="color:#000000;background-color:#ffffff;"><strong><br />
</strong></span>
</p>
<p>
	<span style="color:#000000;background-color:#FFFFFF;"><strong><span style="font-size:14px;">注：</span></strong><span style="font-size:14px;">农场种植的荠菜都是自然生长而成，偏老的适合做馅，包馄饨等，偏嫩的适合烧汤。您在订购的时候可告知您需要的类型。</span></span>
</p>
<p class="MsoNormal" style="text-align:left;" align="left">
	<b><span style="font-size:14px;font-family:宋体;color:#009900;"></span></b><span style="font-size:14px;"> </span>
</p>
<p class="MsoNormal" style="text-align:left;" align="left">
...
<p>
	2.所含粗纤维、胡萝卜素和维生素Ｂ１、Ｂ２、Ｂ６、Ｃ等也多为人体所需的营养物质，所以俗语说“三月三，荠菜当灵丹”。
</p>
<p class="MsoNormal" style="text-align:left;" align="left">
	<b><span style="font-size:14px;font-family:宋体;color:#009900;"></span></b><span style="FONT-SIZE: 9pt; FONT-FAMILY: " tahoma?,?sans-serif?;color:black;?=""></span> 
      ...
      <blockquote>
        <div class="paddbox">
          <div class="para" style="color:#333333;margin:15px 0px 5px;background-color:#ffffff;">
	<strong><span style="font-size:16px;color:#009900;">荠菜饼</span></strong> 
</div>
<img alt="" src="/images/upload/image/20141031/20141031103007_71020.jpg" /> 
<div class="para" style="color:#333333;margin:15px 0px 5px;background-color:#ffffff;">
	1、荠菜择洗干净。
</div>
<div class="para" style="color:#333333;margin:15px 0px 5px;background-color:#ffffff;">
	2、开水锅里滴几滴油再加少许盐，将荠菜用沸水绰烫一下。
</div>
<div class="para" style="color:#333333;margin:15px 0px 5px;background-color:#ffffff;">
	3、攥干水分后，切成碎末。
</div>
<div class="para" style="color:#333333;margin:15px 0px 5px;background-color:#ffffff;">
	4、荠菜里打入3个鸡蛋，再加入切碎的葱、加适量盐。
</div>
<div class="para" style="color:#333333;margin:15px 0px 5px;background-color:#ffffff;">
	5、搅拌均匀。
</div>
