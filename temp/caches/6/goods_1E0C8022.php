<?php exit;?>a:3:{s:8:"template";a:5:{i:0;s:35:"D:/WWW/shop/themes/xm2013/goods.dwt";i:1;s:49:"D:/WWW/shop/themes/xm2013/library/page_header.lbi";i:2;s:45:"D:/WWW/shop/themes/xm2013/library/ur_here.lbi";i:3;s:45:"D:/WWW/shop/themes/xm2013/library/history.lbi";i:4;s:49:"D:/WWW/shop/themes/xm2013/library/page_footer.lbi";}s:7:"expires";i:1446897258;s:8:"maketime";i:1446893658;}<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<meta name="Keywords" content="" />
<meta name="Description" content="" />
<title>小排(请提前2天预订)_肉类_肉禽蛋产品_君禾园</title>
...
_mvq.push(['$addGoods', '22', '5', '小排(请提前2天预订)', '81', '28.68', xhNS.your_domain+'images/201409/goods_img/81_G_1410720356638.jpg']);
_mvq.push(['$logData']);
var _mbausername='';
var _mbauserid='0';
</script>
...
<script type="text/javascript" src="themes/xm2013/js/xm.js"></script><div class="block box">
  <div id="ur_here">
    <div class="ur_here">当前位置: <a href=".">首页</a> <code>&gt;</code> <a href="category.php?id=4">肉禽蛋产品</a> <code>&gt;</code> <a href="category.php?id=22">肉类</a> <code>&gt;</code> 小排(请提前2天预订)</div>
  </div>
</div>
<div class="blank"></div>
    ...
    <div class="goods-pic-box">
      <div id="goodsInfo" class="clearfix">
        <div class="goods-big-pic">
          <div class="thumb"><img src="images/201409/goods_img/81_G_1410720356638.jpg" alt="小排(请提前2天预订)" id="goodsimg" style="cursor:pointer;" onclick="window.open('gallery.php?id=81'); return false;"  /></div>
          <div class="blank5"></div>
          <div class="goods-small-pic clearfix">
            <ul id="imglist">
			              <li class="onbg" lang="images/201409/goods_img/81_P_1410720356459.jpg"><img src="images/201409/thumb_img/81_thumb_P_1410720356300.jpg" alt="小排(请提前2天预订)" /></li>
        ...
        <div class="textInfo">
          <form action="javascript:addToCart(81)" method="post" name="ECS_FORMBUY" id="ECS_FORMBUY" >
            <div class="linel clearfix">
              <p class="name">小排(请提前2天预订)</p>
              <p class="grief"></p>
...
<script>window._bd_share_config={"common":{"bdSnsKey":{},"bdText":"","bdMini":"2","bdMiniList":false,"bdPic":"","bdStyle":"1","bdSize":"24"},"share":{},"image":{"viewList":["qzone","tqq","tsina","weixin","sqq","renren"],"viewText":"分享到：","viewSize":"16"},"selectShare":{"bdContainerClass":null,"bdSelectMiniList":["qzone","tqq","tsina","weixin","sqq","renren"]}};with(document)0[(getElementsByTagName('head')[0]||body).appendChild(createElement('script')).src='http://bdimg.share.baidu.com/static/api/js/share.js?v=89860593.js?cdnversion='+~(-new Date()/36e5)];</script>
            <ul>
              <li class="clearfix">
                <dd class="ddL"><strong>本店售价：</strong><font class="shop" style="font-size:18px;font-weight:bold;" id="ECS_SHOPPRICE">￥28.68元</font></dd>
                                                                                                                                                                   <dd class="ddR"><strong>商品编号：</strong>PV20131222</dd>
              </li>
              <li>
                <dd class="ddL"><strong>市场价格：</strong><font class="market">￥32.00元</font></dd>
                <dd class="ddR"><strong>商品品牌：</strong><a href="brand.php?id=5" >其它品牌</a></dd>
              </li>
              <li class="clearfix">
                <dd class="ddL"> 商品库存：<font style="color:#FFB03B">6 </font></dd>
                <dd class="ddR"> 商品点击数：<font style="color:#FFB03B; font-weight:bold;"> 83</font>次</dd>
              </li>
...
-->
			...
			function goods_add(){
                ...
                <div class="blank"></div>
                <div class="buyt"><a href="javascript:addToCart(81)"><img src="themes/xm2013/images/bnt_cat1.gif"/></a> &nbsp;&nbsp; <a href="javascript:collect(81)"><img src="themes/xm2013/images/bnt_colles.gif" /></a></div>
              </li>
            </ul>
          </form>
        </div>
...
document.getElementById('history_list').innerHTML = '您已清空最近浏览过的商品';
  ...
  <div class="AreaR xm-box">
    ...
    <div id="com_h" style="overflow:hidden;">
      <blockquote>
        <p class="MsoNormal">
	<span style="font-size:14px;color:#009900;"><strong>产地：君禾园崇明基地</strong></span><span style="font-size:14px;color:#009900;"><strong>         </strong></span><span style="line-height:1.5;font-size:14px;color:#009900;"><strong>储藏方式：低温储藏</strong></span><span style="line-height:1.5;font-size:14px;color:#009900;"><strong>          </strong></span><span style="line-height:1.5;font-size:14px;color:#009900;"><strong>产品包装：每份净重</strong></span><span style="line-height:1.5;font-size:14px;color:#009900;"><strong>1</strong></span><span style="line-height:1.5;font-size:14px;color:#009900;"><strong>斤</strong></span>
</p>
<p class="MsoNormal">
...
<p class="MsoNormal">
	<span style="line-height:1.5;">注：小排是本公司在崇明代购的产品，根据订单进行采购。一份为一斤，根据需求可订多份。</span><span style="line-height:1.5;">荤菜类请提前</span><span style="line-height:1.5;">2</span><span style="line-height:1.5;">天预订。</span>
</p>
<p class="MsoNormal">
	<br />
</p>
...
<p class="MsoNormal">
	土猪肉又开始走俏市场了，君禾园在崇明代购肉味足、品质好的土猪肉，让市民回忆起“小时候的味道”，我们精心挑选的猪小排肉层比较厚，带着纯正的肉香味。
</p>
<p class="MsoNormal">
	<span><strong> </strong></span>
</p>
<p class="MsoNormal">
	<strong><span style="color:#009900;font-size:14px;">营养价值</span></strong>
</p>
<p class="MsoNormal">
...
<p class="MsoNormal">
	<strong><span style="color:#009900;font-size:14px;">饮食禁忌</span></strong>
</p>
<p class="MsoNormal">
...
<p class="MsoNormal">
	<strong><span style="font-size:14px;color:#009900;">食用效果</span></strong>
</p>
<p class="MsoNormal">
	<span>1</span>、味甘咸、性平，入脾、胃、肾经；
</p>
<p class="MsoNormal">
	<span>2</span>、补肾养血，滋阴润燥；
</p>
<p class="MsoNormal">
	<span>3</span>、主治热病伤津、消渴羸瘦、肾虚体弱、产后血虚、燥咳、便秘、补虚、滋阴、润燥、滋肝阴，润肌肤，利二便和止消渴。
</p>
<br />
<p>
	<br />
      ...
      <blockquote>
        <div class="paddbox">
          <p class="MsoNormal">
	<strong><span style="font-size:14px;color:#009900;">红烧排骨</span></strong>
</p>
<p class="MsoNormal">
	<strong><span style="font-size:14px;color:#009900;"><img src="/images/upload/image/20140915/20140915114927_99305.jpg" alt="" /><br />
</span></strong>
</p>
<p class="MsoNormal">
	<span>1</span>、锅内烧开水，放入斩件排骨氽烫至出血水，捞起洗净，沥净水备用
</p>
<p class="MsoNormal">
	<span>2</span>、锅内放<span>1</span>大匙油，冰糖小火煮至深褐的糖色，加入排骨，炒至均匀上色；
</p>
<p class="MsoNormal">
	<span>3</span>、锅内注入清水<span>400ml</span>（水量刚没过排骨）加入所有调味料（香葱<span>2</span>根、姜片<span>5</span>片、桂皮<span>2</span>小块<span>(8</span>克<span>)</span>、八角<span>2</span>颗、细盐<span>1/2</span>小匙、生抽<span>1</span>大匙、花雕酒<span>1</span>大匙
</p>
<p class="MsoNormal">
	<span>4</span>、大火煮开后，将排骨连汤汁转到深小锅内，加盖小火焖煮<span>60</span>分，煮至水剩约<span>1/3</span>时，将桂皮，姜片，香葱，八角捞出，继续煮至排骨可轻松用筷子插入的程度
</p>
<p class="MsoNormal">
	<span>5</span>、转大火，将汤汁煮至浅浅锅底的位置即可
</p>
<p class="MsoNormal">
	<br />
</p>
<p class="MsoNormal">
	<strong><span style="font-size:14px;color:#009900;">排骨菌菇汤</span></strong>
</p>
<p class="MsoNormal">
	<strong><span style="font-size:14px;color:#009900;"><img src="/images/upload/image/20140915/20140915114950_78843.jpg" alt="" /><br />
</span></strong>
</p>
<p class="MsoNormal">
	<span>1</span>、排骨加姜片、葱段、料酒飞水、冲净后入炖盅
</p>
<p class="MsoNormal">
	<span>2</span>、牛肝菌、姬松茸用温水加白糖泡发，洗净入炖盅；蟹味菇、海味菇去蒂，飞水后入炖盅
</p>
<p class="MsoNormal">
	<span>3</span>、姜切片、葱切段入炖盅，注满清水或温水，盖上盅盖，隔水大火烧<span>20</span>分钟后关中小火慢炖<span>2—3</span>小时，加盐调味即可
</p>
<p class="MsoNormal">
	<b><span> </span></b>
</p>        </div>
