          ...
          <dd>
            <ul>
											<li class="current"><a>全部</a></li>
																<li><a href="category.php?id=5&amp;brand=4&amp;price_min=0&amp;price_max=0">君禾园</a></li>
								            </ul>
          </dd>
        </dl>
    ...
    <div class="xm-box category-list-box"><div class="hd">
        <div class="category-list-order">
          <dl class="xm-filter-list category-order-list clearfix">
            ...
            <dd>
              <ul id="typeSort">
                <li class="default"><a href="category.php?category=5&display=grid&brand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=goods_id&order=DESC#goods_list"><span class="icon-common icon-order-ascending"></span>按上架时间</a></li>
                <li class="default"><a href="category.php?category=5&display=grid&brand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=shop_price&order=ASC#goods_list"><span class="icon-common icon-order-ascending"></span>价格由低到高</a></li>
                <li class="DESC"><a href="category.php?category=5&display=grid&brand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=last_update&order=ASC#goods_list"><span class="icon-common icon-order-ascending"></span>按更新时间排序</a></li>
              </ul>
            </dd>
          </dl>
        </div>
        ...
        <div class="xm-box category-list-box">
          <div class="xm-pagenavi">
		  		  <span class="numbers first">上一页</span>
		  		  		  ...
		  		  		  <span class="numbers current"><a href="category.php?id=5&amp;price_min=0&amp;price_max=0&amp;page=1&amp;sort=last_update&amp;order=DESC">1</a></span>
