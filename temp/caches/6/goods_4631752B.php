<?php exit;?>a:3:{s:8:"template";a:5:{i:0;s:35:"D:/WWW/shop/themes/xm2013/goods.dwt";i:1;s:49:"D:/WWW/shop/themes/xm2013/library/page_header.lbi";i:2;s:45:"D:/WWW/shop/themes/xm2013/library/ur_here.lbi";i:3;s:45:"D:/WWW/shop/themes/xm2013/library/history.lbi";i:4;s:49:"D:/WWW/shop/themes/xm2013/library/page_footer.lbi";}s:7:"expires";i:1446897256;s:8:"maketime";i:1446893656;}<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<meta name="Keywords" content="" />
<meta name="Description" content="" />
<title>芥蓝_茎菜类_蔬菜类_君禾园</title>
...
_mvq.push(['$addGoods', '12', '4', '芥蓝', '123', '16.80', xhNS.your_domain+'images/201410/goods_img/123_G_1414373614563.jpg']);
_mvq.push(['$logData']);
var _mbausername='';
var _mbauserid='0';
</script>
...
<script type="text/javascript" src="themes/xm2013/js/xm.js"></script><div class="block box">
  <div id="ur_here">
    <div class="ur_here">当前位置: <a href=".">首页</a> <code>&gt;</code> <a href="category.php?id=1">蔬菜类</a> <code>&gt;</code> <a href="category.php?id=12">茎菜类</a> <code>&gt;</code> 芥蓝</div>
  </div>
</div>
<div class="blank"></div>
    ...
    <div class="goods-pic-box">
      <div id="goodsInfo" class="clearfix">
        <div class="goods-big-pic">
          <div class="thumb"><img src="images/201410/goods_img/123_G_1414373614563.jpg" alt="芥蓝" id="goodsimg" style="cursor:pointer;" onclick="window.open('gallery.php?id=123'); return false;"  /></div>
          <div class="blank5"></div>
          <div class="goods-small-pic clearfix">
            <ul id="imglist">
			              <li class="onbg" lang="images/201410/goods_img/123_P_1414373614415.jpg"><img src="images/201410/thumb_img/123_thumb_P_1414373614953.jpg" alt="芥蓝" /></li>
            ...
            <ul>
              <li class="clearfix">
                <dd class="ddL"><strong>本店售价：</strong><font class="shop" style="font-size:18px;font-weight:bold;" id="ECS_SHOPPRICE">￥16.80元</font></dd>
                                                                                                                                                                   <dd class="ddR"><strong>商品编号：</strong>BV010208</dd>
              </li>
              <li>
                <dd class="ddL"><strong>市场价格：</strong><font class="market">￥19.00元</font></dd>
                <dd class="ddR"><strong>商品品牌：</strong><a href="brand.php?id=4" >君禾园</a></dd>
              </li>
              <li class="clearfix">
                <dd class="ddL"> 商品库存：<font style="color:#FFB03B">1 </font></dd>
                <dd class="ddR"> 商品点击数：<font style="color:#FFB03B; font-weight:bold;"> 114</font>次</dd>
              </li>
...
-->
			...
			function goods_add(){
                ...
                <div class="blank"></div>
                <div class="buyt"><a href="javascript:addToCart(123)"><img src="themes/xm2013/images/bnt_cat1.gif"/></a> &nbsp;&nbsp; <a href="javascript:collect(123)"><img src="themes/xm2013/images/bnt_colles.gif" /></a></div>
              </li>
            </ul>
          </form>
        </div>
...
document.getElementById('history_list').innerHTML = '您已清空最近浏览过的商品';
  ...
  <div class="AreaR xm-box">
	...
	<b><span style="font-size:14px;color:#009900;">产地：君禾园崇明基地</span></b><b><span style="font-size:14px;color:#009900;">           </span></b><b><span style="font-size:14px;color:#009900;">储藏方式：低温储藏</span></b><b><span style="font-size:14px;color:#009900;">          </span></b><b><span style="font-size:14px;color:#009900;">产品包装：</span></b><b><span style="font-size:14px;color:#009900;">500</span></b><b><span style="font-size:14px;color:#009900;">克</span></b> 
</p>
<p class="MsoNormal" align="left">
	<span style="font-size:14px;color:#009900;"> </span> 
</p>
<p class="MsoNormal" align="left">
	<b><span style="font-size:14px;color:#009900;">商品详情</span></b> 
</p>
<p class="MsoNormal" align="left">
	<span style="font-size:14px;color:#009900;"></span>
</p>
<p class="MsoNormal" align="left">
	<span style="font-size:14px;color:#009900;"><span style="font-size:12px;font-family:arial, 宋体, sans-serif;color:#000000;line-height:24px;">是甘蓝类蔬菜中营养比较丰富的一种蔬菜，可炒食、汤食，或作配菜。芥蓝含</span><span style="font-size:12px;color:#000000;">纤维素</span><span style="font-size:12px;font-family:arial, 宋体, sans-serif;color:#000000;line-height:24px;">、</span><span style="font-size:12px;color:#000000;">糖类</span><span style="font-size:12px;font-family:arial, 宋体, sans-serif;color:#000000;line-height:24px;">等。其味甘，性辛，具备利水化痰、解毒祛风、除</span><span style="font-size:12px;color:#000000;">邪热</span><span style="font-size:12px;font-family:arial, 宋体, sans-serif;color:#000000;line-height:24px;">、解劳乏、清心明目等功效。</span></span> 
</p>
<p class="MsoNormal" align="left">
	<b><span style="font-size:14px;color:#009900;"><br />
</span></b>
</p>
<p class="MsoNormal" align="left">
	<b><span style="font-size:14px;color:#009900;">营养价值</span></b> 
</p>
<span style="font-size:12px;line-height:1.5;">1.芥蓝菜含丰富的维生素A、C、钙、蛋白质、脂肪和植物醣类。</span> 
<p>
	<br />
</p>
<p class="MsoNormal" align="left">
	<span style="font-size:12px;color:#009900;"><span style="font-size:12px;color:#000000;">2.芥蓝中含有有机碱，这使它带有一定的苦味，能刺激人的味觉神经，增进食欲。</span></span> 
</p>
<p class="MsoNormal" align="left">
	<span style="font-size:12px;color:#009900;"><span style="font-size:12px;color:#000000;">3.芥蓝中另一种独特的苦味成分是金鸡纳霜，能抑制过度兴奋的体温中枢，起到消暑解热作用。</span></span> 
</p>
<p class="MsoNormal" align="left">
	<span style="font-size:14px;color:#009900;"><span style="font-size:12px;color:#000000;">4.芥蓝还含有大量膳食纤维。</span><span style="font-size:12px;color:#000000;"></span></span> 
      ...
      <blockquote>
        <div class="paddbox">
          <div class="stepcont mll libdm pvl clearfix" style="vertical-align:baseline;background:#ffffff;color:#333333;margin:0px 0px 0px 20px;">
	<p class="p1" style="font-size:14px;vertical-align:baseline;background:none transparent scroll repeat 0% 0%;">
		<strong><span style="font-size:16px;color:#009900;">白灼芥蓝</span></strong>
	</p>
	<p class="p1" style="font-size:14px;vertical-align:baseline;background:none transparent scroll repeat 0% 0%;">
		<img alt="" src="/images/upload/image/20141028/20141028095120_97058.jpg" /><span style="font-size:12px;"></span>
	</p>
	<p class="p1" style="font-size:14px;vertical-align:baseline;background:none transparent scroll repeat 0% 0%;">
		<span style="font-size:12px;"></span> 
	</p>
	<p class="p1" style="font-size:14px;vertical-align:baseline;background:none transparent scroll repeat 0% 0%;">
		<span style="font-size:12px;">1芥蓝洗净、大蒜切末备用；</span>
	</p>
</div>
<div class="stepcont mll libdm pvl clearfix" style="vertical-align:baseline;background:#ffffff;color:#333333;margin:0px 0px 0px 20px;">
	<p class="p1" style="font-size:14px;vertical-align:baseline;background:none transparent scroll repeat 0% 0%;">
		<span style="font-size:12px;">2煮一锅清水，烧开后，加入适量食盐，放入芥蓝后再放入食用油，大火煮1分钟左右至8成熟，捞出摆盘；</span>
	</p>
</div>
<div class="stepcont mll libdm pvl clearfix" style="vertical-align:baseline;background:#ffffff;color:#333333;margin:0px 0px 0px 20px;">
	<p class="p1" style="font-size:14px;vertical-align:baseline;background:none transparent scroll repeat 0% 0%;">
		<span style="font-size:12px;">3在芥蓝中央均匀地撒上蒜末，淋上蒸鱼豉油；</span>
	</p>
</div>
<div class="stepcont mll libdm pvl clearfix" style="vertical-align:baseline;background:#ffffff;color:#333333;margin:0px 0px 0px 20px;">
	<p class="p1" style="font-size:14px;vertical-align:baseline;background:none transparent scroll repeat 0% 0%;">
		<span style="font-size:12px;">4坐锅烧油，待油开始冒烟，关火，用不锈钢勺子，一勺一勺地将热油淋在蒜末上，即可。</span>
	</p>
</div>        </div>
      </blockquote>
         </div>
