...
<script type="text/javascript" src="themes/xm2013/js/xm.js"></script><div class="block box">
 <div id="ur_here">当前位置: <a href=".">首页</a> <code>&gt;</code> 其它品牌</div>
</div>
<div class="blank"></div>
        ...
        <tr>
          ...
          <br />
            ...
            <div class="brandCategoryA">
                          ...
                          <a href="brand.php?id=5&amp;cat=10" class="f6">根菜类 (4)</a>
                          <a href="brand.php?id=5&amp;cat=11" class="f6">叶菜类 (1)</a>
                          <a href="brand.php?id=5&amp;cat=12" class="f6">茎菜类 (2)</a>
                          <a href="brand.php?id=5&amp;cat=13" class="f6">谷物类 (1)</a>
                          <a href="brand.php?id=5&amp;cat=14" class="f6">豆类 (2)</a>
                          <a href="brand.php?id=5&amp;cat=22" class="f6">肉类 (8)</a>
                          <a href="brand.php?id=5&amp;cat=33" class="f6">菌菇类 (2)</a>
                          <a href="brand.php?id=5&amp;cat=37" class="f6">营养品 (1)</a>
                          </div>  
         </td>
        </tr>
      </table>
  ...
  <div class="xm-box category-list-box"><div class="hd">
        <div class="category-list-order">
          <dl class="xm-filter-list category-order-list clearfix">
            ...
            <dd>
              <ul id="typeSort">
                <li class="DESC"><a href="brand.php?category=0&display=grid&brand=5&price_min=&price_max=&filter_attr=&page=1&sort=goods_id&order=ASC#goods_list"><span class="icon-common icon-order-ascending"></span>按上架时间</a></li>
                <li class="default"><a href="brand.php?category=0&display=grid&brand=5&price_min=&price_max=&filter_attr=&page=1&sort=shop_price&order=ASC#goods_list"><span class="icon-common icon-order-ascending"></span>价格由低到高</a></li>
                <li class="default"><a href="brand.php?category=0&display=grid&brand=5&price_min=&price_max=&filter_attr=&page=1&sort=last_update&order=DESC#goods_list"><span class="icon-common icon-order-ascending"></span>按更新时间排序</a></li>
              </ul>
            </dd>
          </dl>
        </div>
          ...
          <ul class="xm-goods-list clearfix">
              ...
              <div class="xm-goods-item">
                ...
                <div class="item-action"><a class="action-add-cart xmAddShopCart" href="javascript:addToCart(81)" ><span class="icon-common icon-common-plus"></span>加入购物车</a></div>
                                ...
                                <li>
              <div class="xm-goods-item">
                <div class="item-thumb"><a href="goods.php?id=80" title="五花肉(请提前2天预订)"><img src="images/201409/thumb_img/80_thumb_G_1410720255661.jpg" alt="五花肉(请提前2天预订)" /></a></div>
                <h2 class="item-name"><a href="goods.php?id=80" title="五花肉(请提前2天预订)">五花肉(请提前2天预订)</a></h2>
                <div class="item-price">￥50.80元<del>￥58.00元</del></div>
                <div class="item-action"><a class="action-add-cart xmAddShopCart" href="javascript:addToCart(80)" ><span class="icon-common icon-common-plus"></span>加入购物车</a></div>
               
              </div>
            </li>
                                <li>
              <div class="xm-goods-item">
                <div class="item-thumb"><a href="goods.php?id=79" title="猪后腿肉(请提前2天预订)"><img src="images/201409/thumb_img/79_thumb_G_1410720129604.jpg" alt="猪后腿肉(请提前2天预订)" /></a></div>
                <h2 class="item-name"><a href="goods.php?id=79" title="猪后腿肉(请提前2天预订)">猪后腿肉(请提前2天预订)</a></h2>
                <div class="item-price">￥24.00元<del>￥27.59元</del></div>
                <div class="item-action"><a class="action-add-cart xmAddShopCart" href="javascript:addToCart(79)" ><span class="icon-common icon-common-plus"></span>加入购物车</a></div>
        ...
        <div class="xm-box category-list-box">
          <div class="xm-pagenavi">
		  		  <span class="numbers first">上一页</span>
		  		  		  ...
		  		  		  <span class="numbers current"><a href="brand.php?id=5&amp;page=1&amp;sort=goods_id&amp;order=DESC">1</a></span>
