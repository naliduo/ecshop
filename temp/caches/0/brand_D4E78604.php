...
<script type="text/javascript" src="themes/xm2013/js/xm.js"></script><div class="block box">
 <div id="ur_here">当前位置: <a href=".">首页</a> <code>&gt;</code> <a href="category.php?id=1">蔬菜类</a> <code>&gt;</code> <a href="category.php?id=12">茎菜类</a> <code>&gt;</code> 君禾园</div>
</div>
<div class="blank"></div>
  ...
  <div class="xm-box category-list-box"><div class="hd">
        <div class="category-list-order">
          <dl class="xm-filter-list category-order-list clearfix">
            ...
            <dd>
              <ul id="typeSort">
                <li class="default"><a href="brand.php?category=12&display=grid&brand=4&price_min=&price_max=&filter_attr=&page=1&sort=goods_id&order=DESC#goods_list"><span class="icon-common icon-order-ascending"></span>按上架时间</a></li>
                <li class="default"><a href="brand.php?category=12&display=grid&brand=4&price_min=&price_max=&filter_attr=&page=1&sort=shop_price&order=ASC#goods_list"><span class="icon-common icon-order-ascending"></span>价格由低到高</a></li>
                <li class="DESC"><a href="brand.php?category=12&display=grid&brand=4&price_min=&price_max=&filter_attr=&page=1&sort=last_update&order=ASC#goods_list"><span class="icon-common icon-order-ascending"></span>按更新时间排序</a></li>
              </ul>
            </dd>
          </dl>
        </div>
        ...
        <div class="xm-box category-list-box">
          <div class="xm-pagenavi">
		  		  <span class="numbers first">上一页</span>
		  		  		  ...
		  		  		  <span class="numbers current"><a href="brand.php?id=4&amp;cat=12&amp;page=1&amp;sort=last_update&amp;order=DESC">1</a></span>
