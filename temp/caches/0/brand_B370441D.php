  ...
  <div class="xm-box category-list-box"><div class="hd">
        <div class="category-list-order">
          <dl class="xm-filter-list category-order-list clearfix">
            ...
            <dd>
              <ul id="typeSort">
                <li class="default"><a href="brand.php?category=0&display=grid&brand=4&price_min=&price_max=&filter_attr=&page=3&sort=goods_id&order=DESC#goods_list"><span class="icon-common icon-order-ascending"></span>按上架时间</a></li>
                <li class="default"><a href="brand.php?category=0&display=grid&brand=4&price_min=&price_max=&filter_attr=&page=3&sort=shop_price&order=ASC#goods_list"><span class="icon-common icon-order-ascending"></span>价格由低到高</a></li>
                <li class="ASC"><a href="brand.php?category=0&display=grid&brand=4&price_min=&price_max=&filter_attr=&page=3&sort=last_update&order=DESC#goods_list"><span class="icon-common icon-order-ascending"></span>按更新时间排序</a></li>
              </ul>
            </dd>
          </dl>
        </div>
        ...
        <div class="xm-goods-list-wrap">
          <ul class="xm-goods-list clearfix">
              ...
              <div class="xm-goods-item">
                <div class="item-thumb"><a href="goods.php?id=154" title="紫甘蓝"><img src="images/201412/thumb_img/154_thumb_G_1418684774485.jpg" alt="紫甘蓝" /></a></div>
                <h2 class="item-name"><a href="goods.php?id=154" title="紫甘蓝">紫甘蓝</a></h2>
                <div class="item-price">￥16.80元<del>￥19.00元</del></div>
                <div class="item-action"><a class="action-add-cart xmAddShopCart" href="javascript:addToCart(154)" ><span class="icon-common icon-common-plus"></span>加入购物车</a></div>
               
              </div>
            </li>
                                <li>
              <div class="xm-goods-item">
                <div class="item-thumb"><a href="goods.php?id=137" title="塌菜"><img src="images/201411/thumb_img/137_thumb_G_1415906148487.jpg" alt="塌菜" /></a></div>
                <h2 class="item-name"><a href="goods.php?id=137" title="塌菜">塌菜</a></h2>
                <div class="item-price">￥15.00元<del>￥17.00元</del></div>
                <div class="item-action"><a class="action-add-cart xmAddShopCart" href="javascript:addToCart(137)" ><span class="icon-common icon-common-plus"></span>加入购物车</a></div>
              ...
              <div class="xm-goods-item">
                ...
                <div class="item-action"><a class="action-add-cart xmAddShopCart" href="javascript:addToCart(69)" ><span class="icon-common icon-common-plus"></span>加入购物车</a></div>
                                ...
                                <li>
              <div class="xm-goods-item">
                <div class="item-thumb"><a href="goods.php?id=73" title="黑豆"><img src="images/201409/thumb_img/73_thumb_G_1410716050775.jpg" alt="黑豆" /></a></div>
                <h2 class="item-name"><a href="goods.php?id=73" title="黑豆">黑豆</a></h2>
                <div class="item-price">￥16.68元<del>￥19.00元</del></div>
                <div class="item-action"><a class="action-add-cart xmAddShopCart" href="javascript:addToCart(73)" ><span class="icon-common icon-common-plus"></span>加入购物车</a></div>
               
              </div>
            </li>
                                <li>
              <div class="xm-goods-item">
                <div class="item-thumb"><a href="goods.php?id=74" title="小松菜"><img src="images/201505/thumb_img/74_thumb_G_1431033918429.jpg" alt="小松菜" /></a></div>
                <h2 class="item-name"><a href="goods.php?id=74" title="小松菜">小松菜</a></h2>
                <div class="item-price">￥15.00元<del>￥17.00元</del></div>
                <div class="item-action"><a class="action-add-cart xmAddShopCart" href="javascript:addToCart(74)" ><span class="icon-common icon-common-plus"></span>加入购物车</a></div>
               
              </div>
            </li>
                                <li>
              <div class="xm-goods-item">
                <div class="item-thumb"><a href="goods.php?id=75" title="青菜"><img src="images/201409/thumb_img/75_thumb_G_1410719468096.jpg" alt="青菜" /></a></div>
                <h2 class="item-name"><a href="goods.php?id=75" title="青菜">青菜</a></h2>
                <div class="item-price">￥16.68元<del>￥19.18元</del></div>
                <div class="item-action"><a class="action-add-cart xmAddShopCart" href="javascript:addToCart(75)" ><span class="icon-common icon-common-plus"></span>加入购物车</a></div>
               
              </div>
            </li>
                                <li>
              <div class="xm-goods-item">
                <div class="item-thumb"><a href="goods.php?id=76" title="意大利生菜"><img src="images/201505/thumb_img/76_thumb_G_1431976549827.jpg" alt="意大利生菜" /></a></div>
                <h2 class="item-name"><a href="goods.php?id=76" title="意大利生菜">意大利生菜</a></h2>
                <div class="item-price">￥13.50元<del>￥15.53元</del></div>
                <div class="item-action"><a class="action-add-cart xmAddShopCart" href="javascript:addToCart(76)" ><span class="icon-common icon-common-plus"></span>加入购物车</a></div>
               
              </div>
            </li>
                                <li>
              <div class="xm-goods-item">
                <div class="item-thumb"><a href="goods.php?id=78" title="青梗小白菜"><img src="images/201410/thumb_img/78_thumb_G_1413307281252.jpg" alt="青梗小白菜" /></a></div>
                <h2 class="item-name"><a href="goods.php?id=78" title="青梗小白菜">青梗小白菜</a></h2>
                <div class="item-price">￥13.50元<del>￥15.52元</del></div>
                <div class="item-action"><a class="action-add-cart xmAddShopCart" href="javascript:addToCart(78)" ><span class="icon-common icon-common-plus"></span>加入购物车</a></div>
               
              </div>
            </li>
                                <li>
              <div class="xm-goods-item">
                <div class="item-thumb"><a href="goods.php?id=58" title="白皮土豆"><img src="images/201505/thumb_img/58_thumb_G_1431976672940.jpg" alt="白皮土豆" /></a></div>
                <h2 class="item-name"><a href="goods.php?id=58" title="白皮土豆">白皮土豆</a></h2>
                <div class="item-price">￥13.50元<del>￥15.00元</del></div>
                <div class="item-action"><a class="action-add-cart xmAddShopCart" href="javascript:addToCart(58)" ><span class="icon-common icon-common-plus"></span>加入购物车</a></div>
...
var select_spe = "请选择商品属性";
        ...
        <div class="xm-box category-list-box">
          <div class="xm-pagenavi">
		  		  <a class="numbers first" href="brand.php?id=4&amp;page=2&amp;sort=last_update&amp;order=ASC">上一页</a>
		  		  		  ...
		  		  		  <a class="numbers" href="brand.php?id=4&amp;page=1&amp;sort=last_update&amp;order=ASC">1</a>
		  		  		  		  ...
		  		  		  		  <span class="numbers current"><a href="brand.php?id=4&amp;page=3&amp;sort=last_update&amp;order=ASC">3</a></span>
		  		  		  		  ...
		  		  		  		  <a class="numbers last" href="brand.php?id=4&amp;page=4&amp;sort=last_update&amp;order=ASC">下一页</a>
		  		  </div>
        </div>
      </form></div>
  </div>  
