<?php exit;?>a:3:{s:8:"template";a:5:{i:0;s:35:"D:/WWW/shop/themes/xm2013/goods.dwt";i:1;s:49:"D:/WWW/shop/themes/xm2013/library/page_header.lbi";i:2;s:45:"D:/WWW/shop/themes/xm2013/library/ur_here.lbi";i:3;s:45:"D:/WWW/shop/themes/xm2013/library/history.lbi";i:4;s:49:"D:/WWW/shop/themes/xm2013/library/page_footer.lbi";}s:7:"expires";i:1446897271;s:8:"maketime";i:1446893671;}<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<meta name="Keywords" content="" />
<meta name="Description" content="" />
<title>葱姜蒜_调味料类_蔬菜类_君禾园</title>
...
_mvq.push(['$addGoods', '31', '4', '葱姜蒜', '219', '9.00', xhNS.your_domain+'images/201507/goods_img/219_G_1437590455284.jpg']);
_mvq.push(['$logData']);
var _mbausername='';
var _mbauserid='0';
</script>
...
<script type="text/javascript" src="themes/xm2013/js/xm.js"></script><div class="block box">
  <div id="ur_here">
    <div class="ur_here">当前位置: <a href=".">首页</a> <code>&gt;</code> <a href="category.php?id=1">蔬菜类</a> <code>&gt;</code> <a href="category.php?id=31">调味料类</a> <code>&gt;</code> 葱姜蒜</div>
  </div>
</div>
<div class="blank"></div>
    ...
    <div class="goods-pic-box">
      <div id="goodsInfo" class="clearfix">
        <div class="goods-big-pic">
          <div class="thumb"><img src="images/201507/goods_img/219_G_1437590455284.jpg" alt="葱姜蒜" id="goodsimg" style="cursor:pointer;" onclick="window.open('gallery.php?id=219'); return false;"  /></div>
          <div class="blank5"></div>
          <div class="goods-small-pic clearfix">
            <ul id="imglist">
			              <li class="onbg" lang="images/201507/goods_img/219_P_1437590455371.jpg"><img src="images/201507/thumb_img/219_thumb_P_1437590455213.jpg" alt="葱姜蒜" /></li>
        ...
        <div class="textInfo">
          <form action="javascript:addToCart(219)" method="post" name="ECS_FORMBUY" id="ECS_FORMBUY" >
...
<script>window._bd_share_config={"common":{"bdSnsKey":{},"bdText":"","bdMini":"2","bdMiniList":false,"bdPic":"","bdStyle":"1","bdSize":"24"},"share":{},"image":{"viewList":["qzone","tqq","tsina","weixin","sqq","renren"],"viewText":"分享到：","viewSize":"16"},"selectShare":{"bdContainerClass":null,"bdSelectMiniList":["qzone","tqq","tsina","weixin","sqq","renren"]}};with(document)0[(getElementsByTagName('head')[0]||body).appendChild(createElement('script')).src='http://bdimg.share.baidu.com/static/api/js/share.js?v=89860593.js?cdnversion='+~(-new Date()/36e5)];</script>
            <ul>
              <li class="clearfix">
                <dd class="ddL"><strong>本店售价：</strong><font class="shop" style="font-size:18px;font-weight:bold;" id="ECS_SHOPPRICE">￥9.00元</font></dd>
                                                                                                                                                                   <dd class="ddR"><strong>商品编号：</strong>ECS000219</dd>
              </li>
              <li>
                <dd class="ddL"><strong>市场价格：</strong><font class="market">￥10.00元</font></dd>
                <dd class="ddR"><strong>商品品牌：</strong><a href="brand.php?id=4" >君禾园</a></dd>
              </li>
              <li class="clearfix">
                <dd class="ddL"> 商品库存：<font style="color:#FFB03B">7 </font></dd>
                <dd class="ddR"> 商品点击数：<font style="color:#FFB03B; font-weight:bold;"> 63</font>次</dd>
              </li>
...
-->
			...
			function goods_add(){
                ...
                <div class="blank"></div>
                <div class="buyt"><a href="javascript:addToCart(219)"><img src="themes/xm2013/images/bnt_cat1.gif"/></a> &nbsp;&nbsp; <a href="javascript:collect(219)"><img src="themes/xm2013/images/bnt_colles.gif" /></a></div>
              </li>
            </ul>
          </form>
        </div>
...
document.getElementById('history_list').innerHTML = '您已清空最近浏览过的商品';
  ...
  <div class="AreaR xm-box">
    ...
    <div id="com_h" style="overflow:hidden;">
      <blockquote>
        <p class="MsoNormal">
	<b><span style="color:#009900;font-size:14px;">产地：君禾园崇明基地      </span></b><b><span style="color:#009900;font-size:14px;">储藏方法：低温       </span></b><b><span style="color:#009900;font-size:14px;">产品包装300-350克</span></b> 
</p>
<p class="MsoNormal">
	<b><u><br />
</u></b> 
...
<p class="MsoNormal">
	<span style="color:#2E3133;font-family:宋体, Arial, Helvetica, sans-serif;font-size:14px;line-height:26px;background-color:#FFFFFF;"><span style="color:#2E3133;font-family:宋体, Arial, Helvetica, sans-serif;font-size:14px;line-height:26px;background-color:#FFFFFF;">君禾园为了客户朋友日常烹饪的方便，提供葱姜蒜组合包。</span>葱、姜、蒜被誉为“厨房三宝</span><span style="color:#2E3133;font-family:宋体, Arial, Helvetica, sans-serif;font-size:14px;line-height:26px;background-color:#FFFFFF;">”，是人们日常生活中不可缺少的调味品。对于它们的健康功效，民间一直有“吃好葱姜蒜，病痛少一半”这句谚语，意思是正确食用葱姜蒜，可以起到预防疾病、增强体质的作用。</span> 
</p>
<p class="MsoNormal">
...
<p class="MsoNormal">
	<b><span style="color:#009900;">营养价值</span></b>
</p>
<p class="MsoNormal">
	<span style="color:#2E3133;font-family:宋体, Arial, Helvetica, sans-serif;font-size:14px;line-height:26px;background-color:#FFFFFF;"><span style="color:#2E3133;font-family:宋体, Arial, Helvetica, sans-serif;font-size:14px;line-height:26px;background-color:#FFFFFF;">葱中的有机硫化物具有抗菌、抗癌、抗炎症的作用，同时可清除体内自由基，具有抗氧化功效。此外，葱能促进血液循环，改善神经系统功能，</span></span>
</p>
<p class="MsoNormal">
	<span style="color:#2E3133;font-family:宋体, Arial, Helvetica, sans-serif;font-size:14px;line-height:26px;background-color:#FFFFFF;"><span style="color:#2E3133;font-family:宋体, Arial, Helvetica, sans-serif;font-size:14px;line-height:26px;background-color:#FFFFFF;">对预防心血管疾病、记忆力下降均有一定的功效。</span></span>
</p>
<p class="MsoNormal">
	<span style="color:#2E3133;font-family:宋体, Arial, Helvetica, sans-serif;font-size:14px;line-height:26px;background-color:#FFFFFF;"><span style="color:#2E3133;font-family:宋体, Arial, Helvetica, sans-serif;font-size:14px;line-height:26px;background-color:#FFFFFF;">蒜中的大蒜素</span><span style="color:#2E3133;font-family:宋体, Arial, Helvetica, sans-serif;font-size:14px;line-height:26px;background-color:#FFFFFF;">能促进人体对维生素B1的吸收，具有杀菌、降血脂、抗癌等功能，它所含微量元素硒、锗等都具有抗癌作用。</span></span>
</p>
<p class="MsoNormal">
	<span style="color:#2E3133;font-family:宋体, Arial, Helvetica, sans-serif;font-size:14px;line-height:26px;background-color:#FFFFFF;"><span style="color:#2E3133;font-family:宋体, Arial, Helvetica, sans-serif;font-size:14px;line-height:26px;background-color:#FFFFFF;">姜中的姜辣素还能增强血液循环、刺激胃液分泌、兴奋肠道，起到促进消化、健胃、增进食欲的作用。</span></span>
</p>
<p class="MsoNormal">
	<span style="color:#2E3133;font-family:宋体, Arial, Helvetica, sans-serif;font-size:14px;line-height:26px;background-color:#FFFFFF;"><span style="color:#2E3133;font-family:宋体, Arial, Helvetica, sans-serif;font-size:14px;line-height:26px;background-color:#FFFFFF;">另外，葱姜蒜有很强的抗氧化性，烹调时，</span></span><span style="color:#2E3133;font-family:宋体, Arial, Helvetica, sans-serif;font-size:14px;line-height:26px;background-color:#FFFFFF;">加一些葱姜蒜有利于延缓并减少维C被破坏。</span><span style="color:#2E3133;font-family:宋体, Arial, Helvetica, sans-serif;font-size:14px;line-height:26px;background-color:#FFFFFF;"></span>
</p>
<p class="MsoNormal">
	<br />
</p>
