<?php exit;?>a:3:{s:8:"template";a:5:{i:0;s:35:"D:/WWW/shop/themes/xm2013/goods.dwt";i:1;s:49:"D:/WWW/shop/themes/xm2013/library/page_header.lbi";i:2;s:45:"D:/WWW/shop/themes/xm2013/library/ur_here.lbi";i:3;s:45:"D:/WWW/shop/themes/xm2013/library/history.lbi";i:4;s:49:"D:/WWW/shop/themes/xm2013/library/page_footer.lbi";}s:7:"expires";i:1446890710;s:8:"maketime";i:1446887110;}<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<meta name="Keywords" content="" />
<meta name="Description" content="" />
<title>羊前腿（1/4只羊肉带肋排）提前两天预定_肉类_肉禽蛋产品_君禾园</title>
...
_mvq.push(['$addGoods', '22', '5', '羊前腿（1/4只羊肉带肋排）提前两天预定', '239', '450.00', xhNS.your_domain+'images/201510/goods_img/239_G_1445815079025.jpg']);
_mvq.push(['$logData']);
var _mbausername='';
var _mbauserid='';
</script>
...
<script type="text/javascript" src="themes/xm2013/js/xm.js"></script><div class="block box">
  <div id="ur_here">
    <div class="ur_here">当前位置: <a href=".">首页</a> <code>&gt;</code> <a href="category.php?id=4">肉禽蛋产品</a> <code>&gt;</code> <a href="category.php?id=22">肉类</a> <code>&gt;</code> 羊前腿（1/4只羊肉带肋排）提前两天预定</div>
  </div>
</div>
<div class="blank"></div>
    ...
    <div class="goods-pic-box">
      <div id="goodsInfo" class="clearfix">
        <div class="goods-big-pic">
          <div class="thumb"><img src="images/201510/goods_img/239_G_1445815079025.jpg" alt="羊前腿（1/4只羊肉带肋排）提前两天预定" id="goodsimg" style="cursor:pointer;" onclick="window.open('gallery.php?id=239'); return false;"  /></div>
          <div class="blank5"></div>
          <div class="goods-small-pic clearfix">
            <ul id="imglist">
			              <li class="onbg" lang="images/201510/goods_img/239_P_1445815079047.jpg"><img src="images/201510/thumb_img/239_thumb_P_1445815079644.jpg" alt="羊前腿（1/4只羊肉带肋排）提前两天预定" /></li>
        ...
        <div class="textInfo">
          <form action="javascript:addToCart(239)" method="post" name="ECS_FORMBUY" id="ECS_FORMBUY" >
            <div class="linel clearfix">
              <p class="name">羊前腿（1/4只羊肉带肋排）提前两天预定</p>
              <p class="grief"></p>
...
<script>window._bd_share_config={"common":{"bdSnsKey":{},"bdText":"","bdMini":"2","bdMiniList":false,"bdPic":"","bdStyle":"1","bdSize":"24"},"share":{},"image":{"viewList":["qzone","tqq","tsina","weixin","sqq","renren"],"viewText":"分享到：","viewSize":"16"},"selectShare":{"bdContainerClass":null,"bdSelectMiniList":["qzone","tqq","tsina","weixin","sqq","renren"]}};with(document)0[(getElementsByTagName('head')[0]||body).appendChild(createElement('script')).src='http://bdimg.share.baidu.com/static/api/js/share.js?v=89860593.js?cdnversion='+~(-new Date()/36e5)];</script>
            <ul>
              <li class="clearfix">
                <dd class="ddL"><strong>本店售价：</strong><font class="shop" style="font-size:18px;font-weight:bold;" id="ECS_SHOPPRICE">￥450.00元</font></dd>
                                                                                                                                                                   <dd class="ddR"><strong>商品编号：</strong>OMM151026</dd>
              </li>
              <li>
                <dd class="ddL"><strong>市场价格：</strong><font class="market">￥517.00元</font></dd>
                <dd class="ddR"><strong>商品品牌：</strong><a href="brand.php?id=5" >其它品牌</a></dd>
              </li>
              <li class="clearfix">
                <dd class="ddL"> 商品库存：<font style="color:#FFB03B">4 </font></dd>
                <dd class="ddR"> 商品点击数：<font style="color:#FFB03B; font-weight:bold;"> 13</font>次</dd>
              </li>
...
-->
			...
			function goods_add(){
                ...
                <div class="blank"></div>
                <div class="buyt"><a href="javascript:addToCart(239)"><img src="themes/xm2013/images/bnt_cat1.gif"/></a> &nbsp;&nbsp; <a href="javascript:collect(239)"><img src="themes/xm2013/images/bnt_colles.gif" /></a></div>
              </li>
            </ul>
          </form>
        </div>
...
document.getElementById('history_list').innerHTML = '您已清空最近浏览过的商品';
  ...
  <div class="AreaR xm-box">
    ...
    <div id="com_h" style="overflow:hidden;">
      <blockquote>
        <p>
	<span style="font-size:14px;"><b><span style="font-family:宋体;color:#009900;">产地：崇明代购</span></b><b><span tahoma?,?sans-serif?;color:#009900;?="">         </span></b><b><span style="font-family:宋体;color:#009900;">储藏方式：低温储藏</span></b><b><span tahoma?,?sans-serif?;color:#009900;?="">         </span></b><b><span style="font-family:宋体;color:#009900;">产品包装：45元/500G  (<span style="line-height:27px;background-color:#FFFFFF;">实际价格按采购到的重量来计算)</span></span></b></span> 
</p>
<p class="MsoNormal" align="left" style="color:#656D78;background-color:#FFFFFF;">
	<span style="color:#000000;"></span><span style="font-size:14px;"> </span> 
</p>
<p class="MsoNormal" align="left" style="color:#656D78;background-color:#FFFFFF;">
	<span style="color:#000000;"><span style="font-size:14px;color:#009900;"><strong>注：</strong></span><span style="font-size:14px;color:#009900;"><strong>荤菜类请提前2天预订。</strong></span></span> 
</p>
<p class="MsoNormal" align="left" style="color:#656D78;background-color:#FFFFFF;">
	<b><span style="font-family:宋体;color:#009900;"></span></b><span tahoma?,?sans-serif?;color:black;?="" style="font-size: 9pt;"></span><span style="color:#009900;"><strong> </strong></span> 
</p>
<p class="MsoNormal" align="left" style="color:#656D78;background-color:#FFFFFF;">
	<b><span style="font-size:14px;font-family:宋体;color:#009900;">商品详情</span></b> 
</p>
<p class="MsoNormal" align="left" style="color:#656D78;background-color:#FFFFFF;">
	<span style="font-family:宋体;color:#009900;"><span style="color:#333333;font-size:14px;">崇明白山羊，是</span><span style="color:#000000;font-size:14px;">崇明县</span><span style="color:#333333;font-size:14px;">特定水土条件下孕育而成的特产。崇明白山羊属皮毛肉兼用型品种，体型中等偏小，体格健壮，具有适应性强、繁殖率高、肉质特别鲜美等特点</span></span> 
</p>
<p class="MsoNormal" align="left" style="color:#656D78;background-color:#FFFFFF;">
	<span style="font-family:宋体;color:#009900;font-size:14px;"><span style="color:#000000;">是本公司在崇明代购的产品，根据订单进行采购。</span></span> 
</p>
<p class="MsoNormal" align="left" style="color:#656D78;background-color:#FFFFFF;">
	<span style="font-family:宋体;color:#009900;"><span style="color:#000000;"><span style="font-size:18px;background-color:#FFE500;"><br />
</span></span></span> 
</p>
<p class="MsoNormal" align="left" style="color:#656D78;background-color:#FFFFFF;">
	<span style="font-family:宋体;color:#009900;"><span style="color:#000000;"><span style="font-size:18px;background-color:#FFE500;">重量约7-10斤不等。价格在315元-450元左右。实际价格按采购到的重量来计算。</span></span></span> 
</p>
<p class="MsoNormal" align="left">
	<span style="font-size:16px;color:#000000;"><span style="line-height:27px;color:#000000;background-color:#FFE500;">农家定点采购食品不享受折扣价，请见谅！</span></span> 
</p>
<p class="MsoNormal" align="left" style="color:#656D78;background-color:#FFFFFF;">
	<span style="font-family:宋体;color:#009900;"><span style="color:#000000;"></span></span> 
</p>
<p class="MsoNormal" align="left" style="color:#656D78;background-color:#FFFFFF;">
	<span style="font-family:宋体;color:#009900;"><span style="color:#000000;"><b><span style="font-size:14px;color:#009900;"><br />
营养价值</span></b></span></span> 
</p>
<p class="MsoNormal" align="left" style="color:#656D78;background-color:#FFFFFF;">
	<span style="color:#333333;font-family:宋体;line-height:1.5;font-size:14px;">羊肉性温，冬季常吃羊肉，不仅可以增加人体热量，抵御寒冷，而且还能增加消化酶，保护胃壁，修复胃粘膜，帮助脾胃消化，起到抗衰老的作用。</span> 
</p>
<p class="MsoNormal" align="left" style="color:#656D78;background-color:#FFFFFF;">
	<span style="font-family:宋体;color:#009900;"><span style="color:#000000;"><span style="color:#009900;"><span style="color:#333333;"><br />
<span style="font-size:14px;"><span style="color:#009900;"><strong>羊肉食用禁忌</strong></span><span style="color:#009900;">：</span></span><br />
</span></span></span></span> 
</p>
<p>
	<span style="font-size:14px;color:#000000;">湿热质体质应忌食或少食 </span> 
</p>
<br />
<p>
	<br />
...
<p class="MsoNormal" align="left" style="color:#656D78;background-color:#FFFFFF;">
	<b><span style="font-family:宋体;color:#009900;"></span></b><span tahoma?,?sans-serif?;color:black;?="" style="font-size: 9pt;"></span> 
</p>
<br />        <div class="blank"></div>
      ...
      <blockquote>
        <div class="paddbox">
          <p>
	<span style="font-size:14px;">红焖羊腿：</span> 
</p>
<p>
	<span style="font-size:14px;"><img src="/images/upload/image/20151026/20151026152240_61940.jpg" alt="" /><br />
</span> 
</p>
<p>
	<span style="font-size:14px;"><span style="color:#000000;">1.</span><span style="color:#000000;font-family:Arial, Helvetica, sans-serif;font-size:14px;line-height:24px;background-color:#FFFFFF;">砍骨后的羊腿切大块，冲洗干净</span></span> 
</p>
<p>
	<span style="font-size:14px;"><span style="color:#000000;">2.</span><span style="color:#000000;font-family:Arial, Helvetica, sans-serif;font-size:14px;line-height:24px;background-color:#FFFFFF;">烧一大锅热水，放姜片、葱段、料酒和少量醋，再放入羊肉，煮至出大量血沫时趁热用凉水彻底冲洗干净，装盆备用</span></span> 
</p>
<p>
	<span style="font-size:14px;"><span style="color:#000000;">3.</span><span style="color:#000000;font-family:Arial, Helvetica, sans-serif;font-size:14px;line-height:24px;background-color:#FFFFFF;">依次放入香料、葱白、姜片、大蒜和干辣椒，爆出香味后，放入羊肉翻炒，稍多炒一会，把羊肉的水分炒干</span></span> 
</p>
<p>
	<span style="font-size:14px;"><span style="color:#000000;">4.</span><span style="color:#000000;font-family:Arial, Helvetica, sans-serif;font-size:14px;line-height:24px;background-color:#FFFFFF;">烹入几滴香醋，再放料酒、老抽、生抽继续翻炒，要多炒一会让羊肉上色，闻到很香的时候，加入适量热水，再次煮开后，放红枣和葱叶，移入砂锅，小火保持微微沸腾，炖约两个半小时（根据个人口味适量加盐）</span></span> 
</p>
<p>
	<br />
</p>        </div>
