<?php exit;?>a:3:{s:8:"template";a:6:{i:0;s:38:"D:/WWW/shop/themes/xm2013/category.dwt";i:1;s:49:"D:/WWW/shop/themes/xm2013/library/page_header.lbi";i:2;s:45:"D:/WWW/shop/themes/xm2013/library/history.lbi";i:3;s:48:"D:/WWW/shop/themes/xm2013/library/goods_list.lbi";i:4;s:44:"D:/WWW/shop/themes/xm2013/library/pages2.lbi";i:5;s:49:"D:/WWW/shop/themes/xm2013/library/page_footer.lbi";}s:7:"expires";i:1446897199;s:8:"maketime";i:1446893599;}<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<meta name="Keywords" content="" />
<meta name="Description" content="" />
<title>肉禽蛋产品_君禾园</title>
...
<script type="text/javascript" src="js/common.js"></script><script type="text/javascript" src="js/transport.js"></script><script type="text/javascript" src="js/utils.js"></script><script>
var _mvq = _mvq || [];
_mvq.push(['$setAccount', 'm-29971-0']);
_mvq.push(['$setGeneral', 'category', '', '', '0']);
_mvq.push(['$logConversion']);
_mvq.push(['$addCategory', '肉禽蛋产品', '4']);
_mvq.push(['$logData']);
</script>
...
<script type="text/javascript" src="themes/xm2013/js/xm.js"></script><script type="text/javascript">
    ...
    <div class="xm-box">
      ...
      <div class="bd">
        <ul class="xm-goods-sublist xm-goods-sublist-l">
		          <li>
            <div class="item-name"><a href="goods.php?id=243" title="秋冬补肾健脾套餐（老母鸡/山药/葱姜蒜）">秋冬补肾健脾套餐（老母鸡/山药...</a></div>
            <div class="item-price">￥138.00元</div>
            <div class="item-thumb"><a href="goods.php?id=243" title="秋冬补肾健脾套餐（老母鸡/山药/葱姜蒜）"><img src="images/201511/thumb_img/243_thumb_G_1446767724779.jpg" alt="秋冬补肾健脾套餐（老母鸡/山药/葱姜蒜）" /></a></div>
          </li>
                 <li>
            <div class="item-name"><a href="goods.php?id=234" title="老母鸡">老母鸡</a></div>
            <div class="item-price">￥158.40元</div>
            <div class="item-thumb"><a href="goods.php?id=234" title="老母鸡"><img src="images/201510/thumb_img/234_thumb_G_1444440858447.jpg" alt="老母鸡" /></a></div>
                 ...
                 <li>
            <div class="item-name"><a href="goods.php?id=239" title="羊前腿（1/4只羊肉带肋排）提前两天预定">羊前腿（1/4只羊肉带肋排）提...</a></div>
            <div class="item-price">￥450.00元</div>
            <div class="item-thumb"><a href="goods.php?id=239" title="羊前腿（1/4只羊肉带肋排）提前两天预定"><img src="images/201510/thumb_img/239_thumb_G_1445815079656.jpg" alt="羊前腿（1/4只羊肉带肋排）提前两天预定" /></a></div>
          </li>
               </ul>
      </div>
    </div>
...
document.getElementById('history_list').innerHTML = '您已清空最近浏览过的商品';
  ...
  <div class="span12">
    <div class="category-bn-box clearfix">
 	      ...
 	      <div class="category-bn9"><a href='affiche.php?ad_id=27&uri=' target='_blank'><img src='data/afficheimg/1381122527570139896.jpg' width='691' height='180' /></a></div>
	    
    	      <div class="category-bn3"><a href='affiche.php?ad_id=28&uri=' target='_blank'><img src='data/afficheimg/1411588533790069986.jpg' width='231' height='180' /></a></div>
    ...
    <div class="xm-box category-filter-box">
      <div class="hd">
        ...
        <div class="category-filter-meta">共14个商品</div>
      </div>
	        <div class="bd">
          ...
          <dd>
            <ul>
											<li class="current"><a>全部</a></li>
																<li><a href="category.php?id=4&amp;brand=4&amp;price_min=0&amp;price_max=0">君禾园</a></li>
																<li><a href="category.php?id=4&amp;brand=5&amp;price_min=0&amp;price_max=0">其它品牌</a></li>
								            </ul>
          </dd>
        </dl>
    ...
    <div class="xm-box category-list-box"><div class="hd">
        <div class="category-list-order">
          <dl class="xm-filter-list category-order-list clearfix">
            ...
            <dd>
              <ul id="typeSort">
                <li class="ASC"><a href="category.php?category=4&display=grid&brand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=goods_id&order=DESC#goods_list"><span class="icon-common icon-order-ascending"></span>按上架时间</a></li>
                <li class="default"><a href="category.php?category=4&display=grid&brand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=shop_price&order=ASC#goods_list"><span class="icon-common icon-order-ascending"></span>价格由低到高</a></li>
                <li class="default"><a href="category.php?category=4&display=grid&brand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=last_update&order=DESC#goods_list"><span class="icon-common icon-order-ascending"></span>按更新时间排序</a></li>
              </ul>
            </dd>
          </dl>
        </div>
        ...
        <div class="xm-goods-list-wrap">
          <ul class="xm-goods-list clearfix">
              ...
              <div class="xm-goods-item">
                <div class="item-thumb"><a href="goods.php?id=68" title="草鸡"><img src="images/201409/thumb_img/68_thumb_G_1410717165653.jpg" alt="草鸡" /></a></div>
                <h2 class="item-name"><a href="goods.php?id=68" title="草鸡">草鸡</a></h2>
                <div class="item-price">￥176.00元<del>￥202.00元</del></div>
                <div class="item-action"><a class="action-add-cart xmAddShopCart" href="javascript:addToCart(68)" ><span class="icon-common icon-common-plus"></span>加入购物车</a></div>
                <div class="item-flags"><span class="icon-saleoff icon-saleoff-0">热销</span></div>
              </div>
            </li>
                                <li>
              <div class="xm-goods-item">
                <div class="item-thumb"><a href="goods.php?id=69" title="草鸭"><img src="images/201409/thumb_img/69_thumb_G_1410831400260.jpg" alt="草鸭" /></a></div>
                <h2 class="item-name"><a href="goods.php?id=69" title="草鸭">草鸭</a></h2>
                <div class="item-price">￥176.00元<del>￥202.00元</del></div>
                <div class="item-action"><a class="action-add-cart xmAddShopCart" href="javascript:addToCart(69)" ><span class="icon-common icon-common-plus"></span>加入购物车</a></div>
                <div class="item-flags"><span class="icon-saleoff icon-saleoff-0">热销</span></div>
              </div>
            </li>
                                <li>
              <div class="xm-goods-item">
                <div class="item-thumb"><a href="goods.php?id=70" title="生态鸡蛋"><img src="images/201501/thumb_img/70_thumb_G_1422469038507.jpg" alt="生态鸡蛋" /></a></div>
                <h2 class="item-name"><a href="goods.php?id=70" title="生态鸡蛋">生态鸡蛋</a></h2>
                <div class="item-price">￥18.00元<del>￥20.00元</del></div>
                <div class="item-action"><a class="action-add-cart xmAddShopCart" href="javascript:addToCart(70)" ><span class="icon-common icon-common-plus"></span>加入购物车</a></div>
                <div class="item-flags"><span class="icon-saleoff icon-saleoff-0">推荐</span></div>
              </div>
            </li>
                                <li>
              <div class="xm-goods-item">
                <div class="item-thumb"><a href="goods.php?id=81" title="小排(请提前2天预订)"><img src="images/201409/thumb_img/81_thumb_G_1410720356185.jpg" alt="小排(请提前2天预订)" /></a></div>
                <h2 class="item-name"><a href="goods.php?id=81" title="小排(请提前2天预订)">小排(请提前2天预订)</a></h2>
                <div class="item-price">￥28.68元<del>￥32.00元</del></div>
                <div class="item-action"><a class="action-add-cart xmAddShopCart" href="javascript:addToCart(81)" ><span class="icon-common icon-common-plus"></span>加入购物车</a></div>
                <div class="item-flags"><span class="icon-saleoff icon-saleoff-0"></span></div>
              </div>
            </li>
                                <li>
              <div class="xm-goods-item">
                <div class="item-thumb"><a href="goods.php?id=110" title="生态鸭蛋"><img src="images/201410/thumb_img/110_thumb_G_1412896108734.jpg" alt="生态鸭蛋" /></a></div>
                <h2 class="item-name"><a href="goods.php?id=110" title="生态鸭蛋">生态鸭蛋</a></h2>
                <div class="item-price">￥16.68元<del>￥19.00元</del></div>
                <div class="item-action"><a class="action-add-cart xmAddShopCart" href="javascript:addToCart(110)" ><span class="icon-common icon-common-plus"></span>加入购物车</a></div>
                <div class="item-flags"><span class="icon-saleoff icon-saleoff-0">新品</span></div>
              </div>
            </li>
                                <li>
              <div class="xm-goods-item">
                <div class="item-thumb"><a href="goods.php?id=111" title="羊前腿(包括羊头、膘，羊肝或羊..."><img src="images/201501/thumb_img/111_thumb_G_1420479303947.jpg" alt="羊前腿(包括羊头、膘，羊肝或羊..." /></a></div>
                <h2 class="item-name"><a href="goods.php?id=111" title="羊前腿(包括羊头、膘，羊肝或羊...">羊前腿(包括羊头、膘，羊肝或羊...</a></h2>
                <div class="item-price">￥360.00元<del>￥413.00元</del></div>
                <div class="item-action"><a class="action-add-cart xmAddShopCart" href="javascript:addToCart(111)" ><span class="icon-common icon-common-plus"></span>加入购物车</a></div>
                <div class="item-flags"><span class="icon-saleoff icon-saleoff-0"></span></div>
              </div>
            </li>
                                <li>
              <div class="xm-goods-item">
                <div class="item-thumb"><a href="goods.php?id=112" title="羊后腿(包括羊油部分）提前两天..."><img src="images/201410/thumb_img/112_thumb_G_1412964145550.jpg" alt="羊后腿(包括羊油部分）提前两天..." /></a></div>
                <h2 class="item-name"><a href="goods.php?id=112" title="羊后腿(包括羊油部分）提前两天...">羊后腿(包括羊油部分）提前两天...</a></h2>
                <div class="item-price">￥360.00元<del>￥413.00元</del></div>
                <div class="item-action"><a class="action-add-cart xmAddShopCart" href="javascript:addToCart(112)" ><span class="icon-common icon-common-plus"></span>加入购物车</a></div>
                <div class="item-flags"><span class="icon-saleoff icon-saleoff-0"></span></div>
              </div>
            </li>
                                <li>
              ...
              <div class="xm-goods-item">
                ...
                <div class="item-flags"><span class="icon-saleoff icon-saleoff-0">新品</span></div>
                                ...
                                <li>
              <div class="xm-goods-item">
                <div class="item-thumb"><a href="goods.php?id=237" title="羊后腿（1/4只羊纯肉）提前两..."><img src="images/201510/thumb_img/237_thumb_G_1445813660670.jpg" alt="羊后腿（1/4只羊纯肉）提前两..." /></a></div>
                <h2 class="item-name"><a href="goods.php?id=237" title="羊后腿（1/4只羊纯肉）提前两...">羊后腿（1/4只羊纯肉）提前两...</a></h2>
                <div class="item-price">￥450.00元<del>￥517.00元</del></div>
                <div class="item-action"><a class="action-add-cart xmAddShopCart" href="javascript:addToCart(237)" ><span class="icon-common icon-common-plus"></span>加入购物车</a></div>
                <div class="item-flags"><span class="icon-saleoff icon-saleoff-0">新品</span></div>
              </div>
            </li>
                                <li>
              <div class="xm-goods-item">
                <div class="item-thumb"><a href="goods.php?id=239" title="羊前腿（1/4只羊肉带肋排）提..."><img src="images/201510/thumb_img/239_thumb_G_1445815079656.jpg" alt="羊前腿（1/4只羊肉带肋排）提..." /></a></div>
                <h2 class="item-name"><a href="goods.php?id=239" title="羊前腿（1/4只羊肉带肋排）提...">羊前腿（1/4只羊肉带肋排）提...</a></h2>
                <div class="item-price">￥450.00元<del>￥517.00元</del></div>
                <div class="item-action"><a class="action-add-cart xmAddShopCart" href="javascript:addToCart(239)" ><span class="icon-common icon-common-plus"></span>加入购物车</a></div>
                <div class="item-flags"><span class="icon-saleoff icon-saleoff-0">新品</span></div>
              </div>
            </li>
        ...
        <div class="xm-box category-list-box">
          <div class="xm-pagenavi">
		  		  <span class="numbers first">上一页</span>
		  		  		  ...
		  		  		  <span class="numbers current"><a href="category.php?id=4&amp;price_min=0&amp;price_max=0&amp;page=1&amp;sort=goods_id&amp;order=ASC">1</a></span>
		  		  		  		  <a class="numbers" href="category.php?id=4&amp;price_min=0&amp;price_max=0&amp;page=2&amp;sort=goods_id&amp;order=ASC">2</a>
		  		  		  		  <a class="numbers last" href="category.php?id=4&amp;price_min=0&amp;price_max=0&amp;page=2&amp;sort=goods_id&amp;order=ASC">下一页</a>
		  		  </div>
        </div>
      </form></div>
  </div>
