<?php exit;?>a:3:{s:8:"template";a:5:{i:0;s:35:"D:/WWW/shop/themes/xm2013/goods.dwt";i:1;s:49:"D:/WWW/shop/themes/xm2013/library/page_header.lbi";i:2;s:45:"D:/WWW/shop/themes/xm2013/library/ur_here.lbi";i:3;s:45:"D:/WWW/shop/themes/xm2013/library/history.lbi";i:4;s:49:"D:/WWW/shop/themes/xm2013/library/page_footer.lbi";}s:7:"expires";i:1446896827;s:8:"maketime";i:1446893227;}<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<meta name="Keywords" content="" />
<meta name="Description" content="" />
<title>羊后腿（1/4只羊纯肉）提前两天预定_肉类_肉禽蛋产品_君禾园</title>
...
_mvq.push(['$addGoods', '22', '5', '羊后腿（1/4只羊纯肉）提前两天预定', '237', '450.00', xhNS.your_domain+'images/201510/goods_img/237_G_1445813660021.jpg']);
_mvq.push(['$logData']);
var _mbausername='';
var _mbauserid='';
</script>
...
<script type="text/javascript" src="themes/xm2013/js/xm.js"></script><div class="block box">
  <div id="ur_here">
    <div class="ur_here">当前位置: <a href=".">首页</a> <code>&gt;</code> <a href="category.php?id=4">肉禽蛋产品</a> <code>&gt;</code> <a href="category.php?id=22">肉类</a> <code>&gt;</code> 羊后腿（1/4只羊纯肉）提前两天预定</div>
  </div>
</div>
<div class="blank"></div>
    ...
    <div class="goods-pic-box">
      <div id="goodsInfo" class="clearfix">
        <div class="goods-big-pic">
          <div class="thumb"><img src="images/201510/goods_img/237_G_1445813660021.jpg" alt="羊后腿（1/4只羊纯肉）提前两天预定" id="goodsimg" style="cursor:pointer;" onclick="window.open('gallery.php?id=237'); return false;"  /></div>
          <div class="blank5"></div>
          <div class="goods-small-pic clearfix">
            <ul id="imglist">
			              <li class="onbg" lang="images/201510/goods_img/237_P_1445813660497.jpg"><img src="images/201510/thumb_img/237_thumb_P_1445813660392.jpg" alt="羊后腿（1/4只羊纯肉）提前两天预定" /></li>
        ...
        <div class="textInfo">
          <form action="javascript:addToCart(237)" method="post" name="ECS_FORMBUY" id="ECS_FORMBUY" >
            <div class="linel clearfix">
              <p class="name">羊后腿（1/4只羊纯肉）提前两天预定</p>
              <p class="grief"></p>
            ...
            <ul>
              <li class="clearfix">
                <dd class="ddL"><strong>本店售价：</strong><font class="shop" style="font-size:18px;font-weight:bold;" id="ECS_SHOPPRICE">￥450.00元</font></dd>
                                                                                                                                                                   <dd class="ddR"><strong>商品编号：</strong>OMM151025</dd>
              </li>
              <li>
              ...
              <li class="clearfix">
                ...
                <dd class="ddR"> 商品点击数：<font style="color:#FFB03B; font-weight:bold;"> 16</font>次</dd>
              </li>
...
-->
			...
			function goods_add(){
                ...
                <div class="blank"></div>
                <div class="buyt"><a href="javascript:addToCart(237)"><img src="themes/xm2013/images/bnt_cat1.gif"/></a> &nbsp;&nbsp; <a href="javascript:collect(237)"><img src="themes/xm2013/images/bnt_colles.gif" /></a></div>
              </li>
            </ul>
          </form>
        </div>
...
document.getElementById('history_list').innerHTML = '您已清空最近浏览过的商品';
  ...
  <div class="AreaR xm-box">
    ...
    <div id="com_h" style="overflow:hidden;">
      <blockquote>
        <p>
	<span style="font-size:14px;"><b><span style="font-size:14px;font-family:宋体;color:#009900;">产地：崇明代购</span></b><b><span tahoma?,?sans-serif?;color:#009900;?="" style="font-size: 14px;">         </span></b><b><span style="font-size:14px;font-family:宋体;color:#009900;">储藏方式：低温储藏</span></b><b><span tahoma?,?sans-serif?;color:#009900;?="" style="font-size: 14px;">         </span></b><b><span style="font-family:宋体;color:#009900;"><span style="font-size:14px;">产品包装：45元/500G  (<span style="line-height:27px;background-color:#FFFFFF;">实际价格按采购到的重量来计算)</span></span></span></b><span></span> </span> 
</p>
...
<p class="MsoNormal" align="left" style="color:#656D78;background-color:#FFFFFF;">
	<span style="font-family:宋体;color:#009900;font-size:14px;"><span style="color:#000000;font-size:14px;">是本公司在崇明代购的产品，根据订单进行采购。</span></span> 
</p>
<p class="MsoNormal" align="left" style="color:#656D78;background-color:#FFFFFF;">
...
<p class="MsoNormal" align="left">
	<span style="font-size:16px;color:#000000;"><span style="line-height:27px;font-size:16px;color:#000000;background-color:#FFE500;">农家定点采购食品不享受折扣价，请见谅！</span></span> 
</p>
<p class="MsoNormal" align="left" style="color:#656D78;background-color:#FFFFFF;">
...
<span style="font-size:14px;"><span style="color:#009900;background-color:#FFFFFF;"><strong>羊肉食用禁忌</strong></span><span style="color:#009900;background-color:#FFFFFF;">：</span></span><br />
</span></span></span></span> 
</p>
<p>
...
<p>
	<br />
      ...
      <blockquote>
        <div class="paddbox">
          <p>
	<span style="font-size:14px;line-height:21px;"> 小炒羊肉：</span> 
</p>
<p>
	<span style="font-size:14px;line-height:21px;"><img src="/images/upload/image/20151026/20151026145748_22854.jpg" alt="" /><br />
</span> 
</p>
<p>
	<span style="font-size:14px;line-height:21px;">1.将青蒜苗切去叶，只剩蒜白。胡萝卜切片，青椒切象眼片，大葱切寸段，姜，蒜切末。</span> 
</p>
<p>
	<span style="font-size:14px;line-height:21px;">2.将羊肉切薄片，用盐，料酒和淀粉抓匀。锅烧热放油，倒入羊肉炒变色，加少许老抽，盛出。</span> 
</p>
<p>
	<span style="font-size:14px;line-height:21px;">3.锅再加油，倒入姜蒜末。</span> 
</p>
<p>
	<span style="font-size:14px;line-height:21px;">4.加入切好的配菜，翻炒，加盐，胡椒粉，炒匀。</span> 
</p>
<p>
	<span style="font-size:14px;line-height:21px;">5.把炒好的羊肉片加入锅中，翻匀，加鸡精盛出。</span> 
</p>        </div>
      </blockquote>
         </div>
    <script type="text/javascript">
