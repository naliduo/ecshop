...
_mvq.push(['$setGeneral', 'category', '', 'test123', '841']);
      ...
      <div class="lnks clearfix">
        <ul class="lnks-li">
          ...
          <li class="phonelistarr" onmouseover="this.className='phonelistarr nhover'" onmouseout="this.className='phonelistarr'"><a class="lnk " href="http://www.dream-gardens.com.cn/news/" > 君禾动态 </a></li>
                                   <li class="phonelistarr" onmouseover="this.className='phonelistarr nhover'" onmouseout="this.className='phonelistarr'"><a class="lnk " href="goodbindcard.php" > 会员俱乐部 </a></li>
    ...
    <div class="xm-box">
      ...
      <div class="bd">
        <ul class="xm-goods-sublist xm-goods-sublist-l">
            ...
            <div class="item-price">￥10.40元</div>
            ...
            <div class="item-price">￥10.27元</div>
          ...
          <dd>
            <ul>
											<li class="current"><a>全部</a></li>
																<li><a href="category.php?id=11&amp;brand=4&amp;price_min=0&amp;price_max=0">君禾园</a></li>
								            </ul>
          </dd>
        </dl>
    ...
    <div class="xm-box category-list-box"><div class="hd">
        <div class="category-list-order">
          <dl class="xm-filter-list category-order-list clearfix">
            ...
            <dd>
              <ul id="typeSort">
                <li class="default"><a href="category.php?category=11&display=grid&brand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=goods_id&order=DESC#goods_list"><span class="icon-common icon-order-ascending"></span>按上架时间</a></li>
                <li class="default"><a href="category.php?category=11&display=grid&brand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=shop_price&order=ASC#goods_list"><span class="icon-common icon-order-ascending"></span>价格由低到高</a></li>
                <li class="DESC"><a href="category.php?category=11&display=grid&brand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=last_update&order=ASC#goods_list"><span class="icon-common icon-order-ascending"></span>按更新时间排序</a></li>
              </ul>
            </dd>
          </dl>
        </div>
        ...
        <div class="xm-goods-list-wrap">
          <ul class="xm-goods-list clearfix">
              ...
              <div class="xm-goods-item">
                ...
                <div class="item-price">￥9.75元<del>￥17.25元</del></div>
              ...
              <div class="xm-goods-item">
                ...
                <div class="item-price">￥8.78元<del>￥13.00元</del></div>
              ...
              <div class="xm-goods-item">
                ...
                <div class="item-price">￥9.75元<del>￥17.00元</del></div>
              ...
              <div class="xm-goods-item">
                ...
                <div class="item-price">￥10.40元<del>￥18.40元</del></div>
              ...
              <div class="xm-goods-item">
                ...
                <div class="item-price">￥7.48元<del>￥13.23元</del></div>
              ...
              <div class="xm-goods-item">
                ...
                <div class="item-price">￥10.27元<del>￥18.00元</del></div>
        ...
        <div class="xm-box category-list-box">
          <div class="xm-pagenavi">
		  		  <span class="numbers first">上一页</span>
		  		  		  ...
		  		  		  <span class="numbers current"><a href="category.php?id=11&amp;price_min=0&amp;price_max=0&amp;page=1&amp;sort=last_update&amp;order=DESC">1</a></span>
		  		  		  		  <a class="numbers" href="category.php?id=11&amp;price_min=0&amp;price_max=0&amp;page=2&amp;sort=last_update&amp;order=DESC">2</a>
		  		  		  		  <a class="numbers" href="category.php?id=11&amp;price_min=0&amp;price_max=0&amp;page=3&amp;sort=last_update&amp;order=DESC">3</a>
		  		  		  		  <a class="numbers last" href="category.php?id=11&amp;price_min=0&amp;price_max=0&amp;page=2&amp;sort=last_update&amp;order=DESC">下一页</a>
		  		  </div>
        </div>
      </form></div>
  </div>
