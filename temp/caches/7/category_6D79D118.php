          ...
          <dl class="xm-filter-list category-order-list clearfix">
            ...
            <dd>
              <ul id="typeSort">
                ...
                <li class="ASC"><a href="category.php?category=1&display=grid&brand=0&price_min=0&price_max=0&filter_attr=0&page=4&sort=shop_price&order=DESC#goods_list"><span class="icon-common icon-order-ascending"></span>价格由低到高</a></li>
...
var select_spe = "请选择商品属性";
        ...
        <div class="xm-box category-list-box">
          <div class="xm-pagenavi">
		  		  <a class="numbers first" href="category.php?id=1&amp;price_min=0&amp;price_max=0&amp;page=3&amp;sort=shop_price&amp;order=ASC">上一页</a>
		  		  
		  		  		  <a class="numbers" href="category.php?id=1&amp;price_min=0&amp;price_max=0&amp;page=1&amp;sort=shop_price&amp;order=ASC">1</a>
		  		  		  		  <a class="numbers" href="category.php?id=1&amp;price_min=0&amp;price_max=0&amp;page=2&amp;sort=shop_price&amp;order=ASC">2</a>
		  		  		  		  <a class="numbers" href="category.php?id=1&amp;price_min=0&amp;price_max=0&amp;page=3&amp;sort=shop_price&amp;order=ASC">3</a>
		  		  		  		  <span class="numbers current"><a href="category.php?id=1&amp;price_min=0&amp;price_max=0&amp;page=4&amp;sort=shop_price&amp;order=ASC">4</a></span>
