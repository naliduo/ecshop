...
<?php echo $this->smarty_insert_scripts(array('files'=>'transport.js,common.js,shopping_flow.js')); ?>
...
<?php $this->assign('page',''); ?>
<?php if ($this->_var['step'] == 'cart'): ?>
<?php $this->assign('page','cartview'); ?>
<?php endif; ?>
<?php if ($this->_var['step'] == 'checkout'): ?>
<?php $this->assign('page','checkout'); ?>
<?php endif; ?>
<?php if ($this->_var['step'] == 'done'): ?>
<?php $this->assign('page','ordercreate'); ?>
<?php endif; ?>
_mvq.push(['$setGeneral', '<?php echo htmlspecialchars($this->_var['page']); ?>', '', '<?php echo htmlspecialchars($this->_var['ecs_session']['user_name']); ?>', '<?php echo $this->_var['ecs_session']['user_idescape:"javascript"']; ?>']);
...
?>
_mvq.push(['$addCartGoods', '<?php echo htmlspecialchars($this->_var['goods']['goods_id']); ?>', '<?php echo htmlspecialchars($this->_var['goods']['goods_name']); ?>', '<?php echo htmlspecialchars($this->_var['goods']['goods_price']); ?>', '<?php echo htmlspecialchars($this->_var['goods']['goods_number']); ?>']);
<?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
_mvq.push(['$logData']);
<?php endif; ?>
<?php if ($this->_var['step'] == 'done'): ?>
_mvq.push(['$addOrder', '<?php echo htmlspecialchars($this->_var['order']['order_sn']); ?>', '<?php echo htmlspecialchars($this->_var['order']['order_amount']); ?>']);
<?php $_from = $this->_var['goods_list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'goods');$this->_foreach['goods_list'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['goods_list']['total'] > 0):
    foreach ($_from AS $this->_var['goods']):
        $this->_foreach['goods_list']['iteration']++;
?>
_mvq.push(['$addItem', '<?php echo htmlspecialchars($this->_var['order']['order_sn']); ?>', '<?php echo htmlspecialchars($this->_var['goods']['goods_id']); ?>', '<?php echo htmlspecialchars($this->_var['goods']['goods_name']); ?>', '<?php echo htmlspecialchars($this->_var['goods']['goods_price']); ?>', '<?php echo htmlspecialchars($this->_var['goods']['goods_number']); ?>', window.location.protocol.toString()+"\/\/"+window.location.host.toString()+"\/goods.php?id="+'<?php echo htmlspecialchars($this->_var['goods']['goods_id']); ?>', '']);
<?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
_mvq.push(['$logData']);
<?php endif; ?>
</script>
...
?>
  ...
  <div class="flowBox">
    <h6><span>我的购物车</span></h6>
        <form id="formCart" name="formCart" method="post" action="flow.php">
           <table width="99%" align="center" border="0" cellpadding="5" cellspacing="0" style="border-top:2px solid #abd600">
...
?>
            <tr>
              <td bgcolor="#ffffff" align="center" style="border-bottom:1px solid #e8e8e8;">
                <?php if ($this->_var['goods']['goods_id'] > 0 && $this->_var['goods']['extension_code'] != 'package_buy'): ?>
                  ...
                  <?php else: ?>
                  <div style="float:left;height:110px; margin-right:10px;">
                    <a href="goods.php?id=<?php echo $this->_var['goods']['goods_id']; ?>" target="_blank"><img src="<?php echo $this->_var['goods']['goods_thumb']; ?>" border="0" title="<?php echo htmlspecialchars($this->_var['goods']['goods_name']); ?>" style="width:100px; height:100px;"/></a>                  </div>
...
?>
              ...
              <?php if ($this->_var['show_goods_attribute'] == 1): ?>
              <td bgcolor="#ffffff" style="border-bottom:1px solid #e8e8e8"><?php echo nl2br($this->_var['goods']['goods_attr']); ?> &nbsp;</td>
              <?php endif; ?>
              <?php if ($this->_var['show_marketprice']): ?>
              <td align="right" bgcolor="#ffffff" style="border-bottom:1px solid #e8e8e8"><?php echo $this->_var['goods']['market_price']; ?></td>
              <?php endif; ?>
              <td align="right" bgcolor="#ffffff" style="border-bottom:1px solid #e8e8e8"><?php echo $this->_var['goods']['goods_price']; ?></td>
              <td align="right" bgcolor="#ffffff" style="border-bottom:1px solid #e8e8e8; padding-left:20px;" class="cartnum2">
            
                <?php if ($this->_var['goods']['goods_id'] > 0 && $this->_var['goods']['is_gift'] == 0 && $this->_var['goods']['parent_id'] == 0): ?>
                
                <a href="javascript:void(0);" onclick="goods_cut(<?php echo $this->_var['goods']['rec_id']; ?>);"></a>
<span class="goods_cut" onclick="goods_cut('<?php echo $this->_var['goods']['rec_id']; ?>');"></span>
<input type="text" name="goods_number[<?php echo $this->_var['goods']['rec_id']; ?>]" id="number<?php echo $this->_var['goods']['rec_id']; ?>" value="<?php echo $this->_var['goods']['goods_number']; ?>" size="4" class="number" onblur="if(isNaN(this.value)){alert('请输入数字');return 
false}else{document.getElementById('updatecart').click();}" title="<?php echo $this->_var['lang']['goods_number_tip']; ?>"/><span class="goods_add" onclick="goods_add('<?php echo $this->_var['goods']['rec_id']; ?>');"></span>
                <a href="javascript:void(0);"  onclick="goods_add(<?php echo $this->_var['goods']['rec_id']; ?>);"></a>
                <?php else: ?>
                <?php echo $this->_var['goods']['goods_number']; ?>
                <?php endif; ?>
              </td>
              <td align="right" bgcolor="#ffffff" style="border-bottom:1px solid #e8e8e8"><?php echo $this->_var['goods']['subtotal']; ?></td>
              <td align="center" bgcolor="#ffffff" style="border-bottom:1px solid #e8e8e8">
                <a href="javascript:if (confirm('<?php echo $this->_var['lang']['drop_goods_confirm']; ?>')) location.href='flow.php?step=drop_goods&amp;id=<?php echo $this->_var['goods']['rec_id']; ?>'; " class="f6" style="color:#F60"><?php echo $this->_var['lang']['drop']; ?></a>
                <?php if ($_SESSION['user_id'] > 0 && $this->_var['goods']['extension_code'] != 'package_buy'): ?>
                <a href="javascript:if (confirm('<?php echo $this->_var['lang']['drop_goods_confirm']; ?>')) location.href='flow.php?step=drop_to_collect&amp;id=<?php echo $this->_var['goods']['rec_id']; ?>'; " class="f6" style="color:#F60"><?php echo $this->_var['lang']['drop_to_collect']; ?></a>
                <?php endif; ?>            </td>
            </tr>
            <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
          </table>
          <table width="99%" align="center" border="0" cellpadding="5" cellspacing="1" bgcolor="#dddddd">
            <tr>
              ...
              <div style="float:left">
                ...
                <input name="submit" type="submit" id="updatecart" value="<?php echo $this->_var['lang']['update_cart']; ?>" class="bnt_blue_3"/>
              </div>
        ...
        <table width="99%" align="center" border="0" cellpadding="5" cellspacing="0" bgcolor="#dddddd">
          <tr>
            <td align="right" bgcolor="#ffffff"><a href="./"><img src="themes/xm2013/images/continue.gif" alt="continue" /></a>&nbsp;&nbsp;<a href="flow.php?step=consignee"><img src="themes/xm2013/images/checkout.gif" alt="checkout" /></a></td>
          </tr>
        </table>
...
?><br />
            ...
            <tr>
              ...
              <td align="center" bgcolor="#ffffff"><input type="image" src="themes/xm2013/images/bnt_cat.gif" alt="Add to cart"  border="0" /></td>
            </tr>
            <?php endif; ?>
          </table>
  ...
  <?php endif; ?>
      <?php if ($this->_var['step'] == "addconsignee"): ?>
...
?>
           ...
           <form action="flow.php" method="post" name="theForm" id="theForm" onsubmit="return checkConsignee2(this)">
                    <table width="99%" align="center" border="0" cellpadding="5" cellspacing="1" bgcolor="#dddddd">
...
?>
                          ...
                          <select name="district" id="selDistricts_<?php echo $this->_var['sn']; ?>" <?php if (! $this->_var['district_list']): ?>style="display:none"<?php endif; ?> style="border:1px solid #ccc;">
...
?>
                      ...
                      <tr>
                        ...
                        <td bgcolor="#ffffff" colspan='3'><input name="sign_building" type="text" class="inputBg"  id="sign_building_<?php echo $this->_var['sn']; ?>" value="<?php echo htmlspecialchars($this->_var['consignee']['sign_building']); ?>" /></td>

                      </tr>
                      <?php endif; ?>
                      <tr>
                        <td colspan="4" align="center" bgcolor="#ffffff">
                        <input type="submit" name="Submit" class="bnt_blue_2" value="保存" />
                          <input type="hidden" name="step" value="addconsignee" />
...
?>
          ...
          <input type="hidden" name='nowtime' value='<?php echo $this->_var['nowtime']; ?>' id='nowtime'/>
          <h6><span><?php echo $this->_var['lang']['consignee_info']; ?></span></h6>
          <?php echo $this->smarty_insert_scripts(array('files'=>'utils.js,transport.js')); ?>
             <form action="flow.php" method="post" name="theForm" id="theForm" >
                 ...
                 <div class="flowBox" style='margin:10px 0 0 0'>
                       <table width="99%" align="center" border="0" cellpadding="5" cellspacing="1" bgcolor="#dddddd">
                        <?php $_from = $this->_var['consignee_list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('sn', 'consignee');$this->_foreach['a'] = array('total' => count($_from), 'iteration' => 0);
...
?>
                                      <tr height='25px'>
                                        <td  bgcolor="#ffffff">  &nbsp;&nbsp;&nbsp;  &nbsp;&nbsp;&nbsp;
                                            <input type="radio" name='address_id' value="<?php echo $this->_var['consignee']['address_id']; ?>" <?php if ($this->_var['sn'] == 0): ?> checked <?php endif; ?>/>
                                           <?php $_from = $this->_var['country_list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'country');if (count($_from)):
    foreach ($_from AS $this->_var['country']):
?>
...
?>
                                             ...
                                             <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
                                             <?php echo htmlspecialchars($this->_var['consignee']['address']); ?> <?php echo htmlspecialchars($this->_var['consignee']['zipcode']); ?>,<?php echo htmlspecialchars($this->_var['consignee']['consignee']); ?>,<?php echo htmlspecialchars($this->_var['consignee']['mobile']); ?>,<?php echo htmlspecialchars($this->_var['consignee']['tel']); ?>,<?php echo htmlspecialchars($this->_var['consignee']['email']); ?>

                                          &nbsp;  &nbsp;  &nbsp;  &nbsp;  &nbsp;
                                          <span  id='op<?php echo $this->_var['sn']; ?>'>
                                              <a href="?step=addconsignee&address_id=<?php echo $this->_var['consignee']['address_id']; ?>"  style='color:#F17C08'>编辑</a> &nbsp;&nbsp;
                                                <?php if ($_SESSION['user_id'] > 0 && $this->_var['consignee']['address_id'] > 0): ?>
                                                   <a href="javascript:void(0)" style='color:#F17C08' onclick="if (confirm('<?php echo $this->_var['lang']['drop_consignee_confirm']; ?>')) location.href='flow.php?step=drop_consignee&amp;id=<?php echo $this->_var['consignee']['address_id']; ?>'">删除</a>
                                               <?php endif; ?>
                                          <span>
                                        </td>
                                      </tr>
                        ...
                        <tr>
                            ...
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <?php echo $this->_var['lang']['deliver_goods_time']; ?>
                         ...
                         <tr>
                            ...
                            <input type="button" name="Submit" class="bnt_blue_2" value="<?php echo $this->_var['lang']['shipping_address']; ?>"
        ...
        <div class="flowBox">
        <h6><span><?php echo $this->_var['lang']['goods_list']; ?></span><?php if ($this->_var['allow_edit_cart']): ?>
          <strong><a href="flow.php" class="f6" style='color:#DD4250'><?php echo $this->_var['lang']['modify']; ?></a></strong>
          <?php endif; ?></h6>
        <table width="99%" align="center" border="0" cellpadding="5" cellspacing="1" bgcolor="#dddddd">
            <tr>
...
?>
      ...
      <div class="flowBox">
      <h6><span><?php echo $this->_var['lang']['consignee_info']; ?></span><strong><a href="flow.php?step=consignee" class="f6" style='color:#DD4250'><?php echo $this->_var['lang']['modify']; ?></a></strong></h6>
      <table width="99%" align="center" border="0" cellpadding="5" cellspacing="1" bgcolor="#dddddd">
            <tr>
              <td bgcolor="#ffffff"><?php echo $this->_var['lang']['consignee_name']; ?>:</td>
...
?>
            ...
            <tr>
              <td colspan="6" bgcolor="#ffffff" align="right"><div style="text-align:left; height:0px;">最低起配量限制：每次最低起配量为50元蔬果类产品，每次起配量为90元以上可免运费。</div><label for="ECS_NEEDINSURE">
...
?>
    ...
    <div class="blank"></div>
    <div class="flowBox">
    <h6><span><?php echo $this->_var['lang']['fee_total']; ?></span></h6><?php echo $this->fetch('library/order_total.lbi'); ?><div align="center" style="margin:8px auto;">
<?php if (! $this->_var['notvirtual']): ?>
      <input type="image" src="themes/xm2013/images/bnt_subOrder.gif" />
<?php else: ?>
     <?php if ($this->_var['user_invalid']): ?>
         <img src="themes/xm2013/images/bnt_subOrder.gif" onclick="checkOrderForm2(document.getElementById('theForm'))" style='cursor:pointer'/>
    <?php else: ?>

          <?php if ($this->_var['usercard']): ?>
                 <input type="image" src="themes/xm2013/images/bnt_subOrder.gif" />
          <?php else: ?>
                <img src="themes/xm2013/images/bnt_subOrder.gif" onclick="checkOrderForm(document.getElementById('theForm'))" style='cursor:pointer'/>
