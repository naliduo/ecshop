...
<div id="slideBox" class="slideBox">
  <div class="scroller" style="transition-property: transform; transition-timing-function: cubic-bezier(0, 0, 0.25, 1); transition-duration: 0ms; transform: translate3d(0px, 0px, 0px); max-width:80%; overflow:hidden; margin: 0 auto;">
    <!--<div><a href="javascript:showPic()"><img src="../images/201402/thumb_img/15_thumb_G_1393532283708.jpg"  alt="小米活塞耳机简装版" /></a></div>-->
    <ul>
      <li><a href="javascript:showPic()"> <img src="../../images/201402/goods_img/15_G_1393532283019.jpg"  alt="小米活塞耳机简装版" /></a></li>
       
       
       
       
            <li><a href="javascript:showPic()"><img src="../../images/201403/thumb_img/15_thumb_P_1394560257247.jpg" alt="小米活塞耳机简装版" class="autobg" /></a></li>
       
       
            <li><a href="javascript:showPic()"><img src="../../images/201403/thumb_img/15_thumb_P_1394560258460.jpg" alt="小米活塞耳机简装版" class="autobg" /></a></li>
    ...
    <div  id="Ggallery" class="ui-gallery ui-slider" >
      <div class="bd" style="transition-property: transform; transition-timing-function: cubic-bezier(0, 0, 0.25, 1); transition-duration: 0ms; transform: translate3d(0px, 0px, 0px);">
        <ul style="width:100%;">
                    ...
                    <li style="width:100%;"><a href="javascript:showPic()"><img alt="" src="../../images/201403/goods_img/15_P_1394560257437.jpg"/></a></li>
           
           
                    <li style="width:100%;"><a href="javascript:showPic()"><img alt="" src="../../images/201403/goods_img/15_P_1394560258507.jpg"/></a></li>
...
<section class="s-summary"> <a class="m-fav" id="collect_box" href="javascript:collect(15)" style="display: inline;">2</a>
  <div class="title">
    <h1> 小米活塞耳机简装版 <b></b> </h1>
  </div>
  <div class="summary">
    <ul class="m-prices">
            <li class="deposit item"> <span class="deposit item">促销价：<b>￥88元</b> </span> </li>
            <li> <span class="deposit item">本店售价：<b  id="ECS_SHOPPRICE">￥99元</b></span> </li>
            <li class="o-price"> <span class="key">市场价格：</span>
        <div class="value"> <del> ￥119元 </del> </div>
      </li>
          </ul>
...
<section class="s-buy ui-section-box">
  ...
  <form action="javascript:addToCart(15)" method="post" name="ECS_FORMBUY" id="ECS_FORMBUY" >
    <div class="fields">
      <div style="height: 37px;" class="summary">
        <ul style="position: static;" class="summary-c">
                    <li class="price"><span class="key">促销价：：</span><b class="price-v">￥88元</b></li>
           
          
           
                    <li class="stock"> <span class="key">商品库存：</span><span class="stock-v"> 99 </span> 件</li>
      ...
      <div class="quantity">
        ...
        <div class="items"> <span class="ui-number"> 
          ...
          <input class="num" name="number" id="goods_number" autocomplete="off" value="1" min="1" max="99" type="number">
    ...
    <div class="option" > 
      ...
      <button type="button" class="btn buy" onClick="addToCart1(15)">立即购买</button>
      <button type="button" class="btn cart" onclick="addToCart(15);showDiv()">加入购物车</button>
        ...
        <div id="addCartWin" class="spop">
          <div class="spopro clearfix">
            <table width="100%" border="0">
              <tr>
                <td><div class="spopimg"> <img width="115" height="115" src="../images/201402/goods_img/15_G_1393532283019.jpg"> </div></td>
                <td valign="top" style="text-align:left"><strong class="spopstitle" style="display:block; color:#333; padding-bottom:10px;">小米活塞耳机简装版</strong> <span> 加入数量： <b id="cartNum"></b> </span> <span> 总计金额： <b>￥88元</b> </span> 
...
<section class="s-detail">
  <header   id="inner" style="position: static; top: 0px;height: 40px; width:100% ">
    <ul style="position: static;" id="detail_nav">
      ...
      <li onClick="tab_lick(this)"><a href="#detail-review">评价 <span class="review-count">(1)</span> </a> </li>
  ...
  <div class="wrap"> 
    ...
    <div class="scroller"> 
      ...
      <div class="m-desc current" id="detail-desc">
        <div class="content"> <p>整体表现上，小米活塞耳机是超出我的预期的，比我想象的要好出不少。铝合金腔体、做工还算不错、可以通话、调音走向正确、有品牌，毕竟附带通话功能的它售价不足百元、但音质却超过了很多国产耳机。小米做的这个绝对是良心价格！值得普通用户入手！</p> </div>
      </div>
      <div class="m-review" id="detail-review">
        <div class="content"> <script type="text/javascript" src="js/transport.js"></script><script type="text/javascript" src="js/utils.js"></script><div id="ECS_COMMENT"> 554fcae493e564ee0dc75bdf2ebf94cacomments|a:3:{s:4:"name";s:8:"comments";s:4:"type";i:0;s:2:"id";i:15;}554fcae493e564ee0dc75bdf2ebf94ca</div>
 </div>
      </div>
