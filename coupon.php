...
$smarty->display('coupon.dwt', $cache_id);
die;
...
if(isset($_SESSION['is_login_tip'])  &&  $_SESSION['is_login_tip']){
    $_SESSION['is_login_tip'] = '';
}
/* 初始化分页信息 */
...
function category_get_goods($children, $brand, $min, $max, $ext, $size, $page, $sort, $order)
{
    ...
    /* 获得商品列表 */
    $sql = 'SELECT g.goods_id, g.goods_name, g.goods_name_style, g.market_price, g.is_new, g.is_best, g.is_hot,g.is_bind_card, g.shop_price AS org_price, ' .
    ...
    while ($row = $GLOBALS['db']->fetchRow($res))
    {
        ...
        elseif ($row['is_bind_card'] == 2)
        {
            $watermark_img = "watermark_member_small";
        }
