...
function checkOrderForm2(){
    ...
    $('#comment_box33').fadeIn().css("top",$(document).scrollTop()+100);
    return false;
}
/**
 *
...
function orderSelectedResponse(result)
{
  ...
  if(result.virtual_card)
  {
	 ...
	 if(result.msg)
	 {
		 ...
		 $("#black_bg").css({width:w+'px',height:h+'px'}).fadeIn();
		 $('#comment_box2').fadeIn().css("top",$(document).scrollTop()+100);
	 }
	 else
	 {
		 $("#black_bg").css({width:w+'px',height:h+'px'}).fadeIn();
		 $('#comment_box1').fadeIn().css("top",$(document).scrollTop()+100);
	 }
	 return false;
  }
}
...
function checkOrderForm(frm)
{
  ...
  if (document.getElementById("ECS_SURPLUS"))
  {
    ...
    var error   = Utils.trim(Ajax.call('order.php?act=check_surplus', 'surplus=' + surplus, null, 'GET', 'TEXT', false));
  ...
  if (document.getElementById("ECS_INTEGRAL"))
  {
    ...
    var error    = Utils.trim(Ajax.call('order.php?act=check_integral', 'integral=' + integral, null, 'GET', 'TEXT', false));
