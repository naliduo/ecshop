...
elseif($_REQUEST['step'] == 'recharge')
{
    ...
    /* . */
    $goods_name= $money. " " . '元充值卡';
    $sql = "INSERT INTO " . $ecs->table('order_goods') . "( " .
                "order_id, goods_id, goods_name, goods_sn, product_id, goods_number, market_price, ".
                "goods_price, goods_attr, is_real, extension_code, parent_id, is_gift, goods_attr_id, package_attr_id) VALUES (".
            "'$new_order_id', 0,'$goods_name','',0,1,$money,$money,'',0,'virtual_card',0,0,'','')";            
    $db->query($sql);
    /* 插入订单表 END*/

    ecs_header("Location: recharge.php?step=checkout&money=$money\n");    
    exit;
}
...
');
    ...
    $money = $_GET["money"]; 
    $total['goods_price_formated']=$money;
    $total['amount_formated']=$money;
